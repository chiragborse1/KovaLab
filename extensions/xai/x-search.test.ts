import { withFetchPreconnect } from "getkova/plugin-sdk/test-env";
                ...
                content: [
                  {
                    type: "output_text",
                    text: "Found X posts",
                    annotations: [{ type: "url_citation", url: "https://x.com/kova/status/1" }],
                  },
                ],
              },
            ],
            citations: ["https://x.com/kova/status/1"],
          },
        ),
    } as Response),
  );
