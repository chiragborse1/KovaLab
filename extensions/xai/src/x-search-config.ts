...
function resolveLegacyXSearchConfig(config?: KovaConfig): JsonRecord | undefined {
...
function resolvePluginXSearchConfig(config?: KovaConfig): JsonRecord | undefined {
...
function resolveLegacyGrokWebSearchConfig(config?: KovaConfig): JsonRecord | undefined {
  const web = config?.tools?.web as Record<string, unknown> | undefined;
...
function resolvePluginWebSearchConfig(config?: KovaConfig): JsonRecord | undefined {
  const pluginConfig = config?.plugins?.entries?.xai?.config;
...
export function resolveEffectiveXSearchConfig(config?: KovaConfig): JsonRecord | undefined {
