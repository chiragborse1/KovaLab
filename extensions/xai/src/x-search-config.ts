...
export function resolveLegacyXSearchConfig(config?: KovaConfig): JsonRecord | undefined {
...
export function resolvePluginXSearchConfig(config?: KovaConfig): JsonRecord | undefined {
