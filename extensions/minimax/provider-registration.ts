...
import { MINIMAX_FAST_MODE_STREAM_HOOKS } from "getkova/plugin-sdk/provider-stream-family";
import { fetchMinimaxUsage } from "getkova/plugin-sdk/provider-usage";
...
export function registerMinimaxProviders(api: KovaPluginApi) {
