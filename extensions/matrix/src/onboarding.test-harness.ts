import type { OutputRuntimeEnv } from "getkova/plugin-sdk/runtime";
import type { ChannelSetupWizardAdapter } from "getkova/plugin-sdk/setup";
...
export function createMatrixUpdateKeepCredentialsPrompter(params?: {
  ...
  return createMatrixWizardPrompter({
    ...
    text: {
      ...
      "Matrix device name (optional)": params?.deviceName ?? "Kova Gateway",
    },
    confirm: {
