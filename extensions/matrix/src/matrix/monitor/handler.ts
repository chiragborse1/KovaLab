import { resolveControlCommandGate } from "getkova/plugin-sdk/command-gating";
import {
  evaluateSupplementalContextVisibility,
  resolveChannelContextVisibilityMode,
} from "getkova/plugin-sdk/context-visibility-runtime";
import {
  loadSessionStore,
  resolveSessionStoreEntry,
} from "getkova/plugin-sdk/session-store-runtime";
...
import { MATRIX_KOVA_FINALIZED_PREVIEW_KEY } from "../send/types.js";
...
let acpBindingRuntimePromise:
  | Promise<typeof import("getkova/plugin-sdk/acp-binding-runtime")>
  | undefined;
let sessionBindingRuntimePromise:
  | Promise<typeof import("getkova/plugin-sdk/session-binding-runtime")>
  | undefined;
...
function loadAcpBindingRuntime(): Promise<typeof import("getkova/plugin-sdk/acp-binding-runtime")> {
  acpBindingRuntimePromise ??= import("getkova/plugin-sdk/acp-binding-runtime");
  return acpBindingRuntimePromise;
}

function loadSessionBindingRuntime(): Promise<
  typeof import("getkova/plugin-sdk/session-binding-runtime")
> {
  sessionBindingRuntimePromise ??= import("getkova/plugin-sdk/session-binding-runtime");
...
function buildMatrixFinalizedPreviewContent(): Record<string, unknown> {
  return { [MATRIX_KOVA_FINALIZED_PREVIEW_KEY]: true };
}
