...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/kova-matrix-create-client-test",
    storagePath: "/tmp/kova-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/kova-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/kova-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/kova-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "kova-matrix-default-token-hash",
