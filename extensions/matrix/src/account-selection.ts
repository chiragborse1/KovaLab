...
import { hasConfiguredSecretInput } from "getkova/plugin-sdk/secret-input-runtime";
...
export function resolveMatrixChannelConfig(cfg: KovaConfig): Record<string, unknown> | null {
