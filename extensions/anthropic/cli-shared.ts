...
} from "getkova/plugin-sdk/cli-backend";
...
// steer Kova-managed Claude CLI runs toward a different provider,
...
function isKovaRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isKovaRequestedYolo(context)
