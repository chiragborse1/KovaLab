...
type AgentDefaultsModel = NonNullable<NonNullable<KovaConfig["agents"]>["defaults"]>["model"];
type AgentDefaultsModels = NonNullable<NonNullable<KovaConfig["agents"]>["defaults"]>["models"];
