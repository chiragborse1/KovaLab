...
vi.mock("getkova/plugin-sdk/provider-auth-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("getkova/plugin-sdk/provider-auth-runtime")>();
  return {
    ...actual,
