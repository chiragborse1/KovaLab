...
import { writeFileWithinRoot } from "getkova/plugin-sdk/infra-runtime";
import type {
  SandboxFsBridge,
  SandboxFsStat,
  SandboxResolvedPath,
} from "getkova/plugin-sdk/sandbox";
import { createWritableRenameTargetResolver } from "getkova/plugin-sdk/sandbox";
...
// import, and this helper is not yet part of the `getkova/plugin-sdk/*`
