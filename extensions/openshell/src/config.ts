...
import { buildPluginConfigSchema, type KovaPluginConfigSchema } from "getkova/plugin-sdk/core";
import {
  formatPluginConfigIssue,
  mapPluginConfigIssues,
} from "getkova/plugin-sdk/extension-shared";
...
export function createOpenShellPluginConfigSchema(): KovaPluginConfigSchema {
