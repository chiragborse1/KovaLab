...
function resolveQianfanPreset(cfg: KovaConfig): {
  api: ModelApi;
  baseUrl: string;
...
export function applyQianfanProviderConfig(cfg: KovaConfig): KovaConfig {
  return qianfanPresetAppliers.applyProviderConfig(cfg);
}

export function applyQianfanConfig(cfg: KovaConfig): KovaConfig {
