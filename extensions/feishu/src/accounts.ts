...
import { coerceSecretRef } from "getkova/plugin-sdk/provider-auth";
 ...
 */
export function resolveDefaultFeishuAccountSelection(cfg: KovaConfig): {
  accountId: string;
 ...
 */
export function resolveDefaultFeishuAccountId(cfg: KovaConfig): string {
 ...
 */
function mergeFeishuAccountConfig(cfg: KovaConfig, accountId: string): FeishuConfig {
 ...
 */
export function listEnabledFeishuAccounts(cfg: KovaConfig): ResolvedFeishuAccount[] {
