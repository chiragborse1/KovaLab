...
function registerFeishuDocTools(api: KovaPluginApi) {
...
function registerFeishuChatTools(api: KovaPluginApi) {
  const register = loadBundledEntryExportSync<(api: KovaPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuWikiTools(api: KovaPluginApi) {
  const register = loadBundledEntryExportSync<(api: KovaPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuDriveTools(api: KovaPluginApi) {
  const register = loadBundledEntryExportSync<(api: KovaPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuPermTools(api: KovaPluginApi) {
  const register = loadBundledEntryExportSync<(api: KovaPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
...
function registerFeishuBitableTools(api: KovaPluginApi) {
  const register = loadBundledEntryExportSync<(api: KovaPluginApi) => void>(import.meta.url, {
    specifier: "./api.js",
