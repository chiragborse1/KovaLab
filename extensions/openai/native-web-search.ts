...
import { streamWithPayloadPatch } from "getkova/plugin-sdk/provider-stream-shared";
...
function shouldUseOpenAINativeWebSearchProvider(config: KovaConfig | undefined): boolean {
