...
import { createSubsystemLogger } from "getkova/plugin-sdk/logging-core";
import { resolveClosestSize } from "getkova/plugin-sdk/media-generation-runtime";
import {
...
function shouldAllowPrivateImageEndpoint(req: { provider: string; cfg: KovaConfig | undefined }) {
  ...
  return process.env.KOVA_QA_ALLOW_LOCAL_IMAGE_PROVIDER === "1";
}
...
function hasExplicitOpenAIDirectAuthConfig(cfg: KovaConfig | undefined): boolean {
...
function hasExplicitOpenAIDirectProviderConfig(cfg: KovaConfig | undefined): boolean {
