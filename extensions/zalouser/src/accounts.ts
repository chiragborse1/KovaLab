...
function mergeZalouserAccountConfig(cfg: KovaConfig, accountId: string): ZalouserAccountConfig {
...
function resolveZalouserAccountBase(params: { cfg: KovaConfig; accountId?: string | null }) {
