...
export function createCodexAttemptTurnWatchController(params: {
  ...
  function scheduleCompletionIdleWatch() {
    ...
    completionIdleTimer = setTimeout(fireCompletionIdleTimeout, Math.max(1, timeoutMs - elapsedMs));
  ...
  function scheduleAssistantCompletionIdleWatch() {
    ...
    assistantCompletionIdleTimer = setTimeout(
      fireAssistantCompletionIdleRelease,
      Math.max(1, params.turnAssistantCompletionIdleTimeoutMs - elapsedMs),
    );
  ...
  function scheduleAttemptIdleWatch() {
    ...
    attemptIdleTimer = setTimeout(
      ...
      Math.max(1, params.turnAttemptIdleTimeoutMs - elapsedMs),
    );
  ...
  function scheduleTerminalIdleWatch() {
    ...
    terminalIdleTimer = setTimeout(
      ...
      Math.max(1, params.turnTerminalIdleTimeoutMs - elapsedMs),
    );
  ...
  return {
    ...
    armCompletionIdleWatch: (options?: { timeoutMs?: number }) => {
