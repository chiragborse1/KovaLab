...
import { i as normalizeSecretInputString, n as hasConfiguredSecretInput } from "./secret-input-BpFibtWM.js";
import { t as BlueBubblesChannelConfigSchema } from "./config-schema-C8g77Gu0.js";
import { n as createBlueBubblesConversationBindingManager } from "./conversation-bindings-B2MMMTxr.js";
import { n as normalizeBlueBubblesAcpConversationId, r as resolveBlueBubblesConversationIdFromTarget, t as matchBlueBubblesAcpConversation } from "./conversation-id-CMVZSNtz.js";
import { n as resolveBlueBubblesGroupToolPolicy, t as resolveBlueBubblesGroupRequireMention } from "./group-policy-CUR92LWc.js";
import { n as collectRuntimeConfigAssignments, r as secretTargetRegistryEntries } from "./secret-contract-uvvszsh3.js";
import { t as DEFAULT_WEBHOOK_PATH } from "./webhook-shared-BKRsgyfk.js";
...
import { createOpenGroupPolicyRestrictSendersWarningCollector, projectAccountWarningCollector } from "openclaw/plugin-sdk/channel-policy";
import { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary } from "openclaw/plugin-sdk/channel-status";
import { createLazyRuntimeNamedExport } from "openclaw/plugin-sdk/lazy-runtime";
import { collectIssuesForEnabledAccounts, createComputedAccountStatusAdapter, createDefaultChannelRuntimeState } from "openclaw/plugin-sdk/status-helpers";
import { normalizeOptionalLowercaseString, normalizeOptionalString } from "openclaw/plugin-sdk/text-runtime";
import { createLegacyPrivateNetworkDoctorContract, isPrivateNetworkOptInEnabled } from "openclaw/plugin-sdk/ssrf-runtime";
...
import { DEFAULT_ACCOUNT_ID as DEFAULT_ACCOUNT_ID$1, addWildcardAllowFrom, createAllowFromSection, createPromptParsedAllowFromForAccount, createSetupInputPresenceValidator, createStandardChannelSetupStatus, formatDocsLink, normalizeAccountId, patchScopedAccountConfig, prepareScopedSetupConfig } from "openclaw/plugin-sdk/setup";
...
const loadBlueBubblesActionsRuntime = createLazyRuntimeNamedExport(() => import("./actions.runtime-X6zYoDym.js"), "blueBubblesActionsRuntime");
...
function applyBlueBubblesConnectionConfig(params) {
	...
	if (params.accountId === DEFAULT_ACCOUNT_ID) return {
		...params.cfg,
		channels: {
			...params.cfg.channels,
			bluebubbles: {
...
const dmPolicy = {
	...
	resolveConfigKeys: (cfg, accountId) => (accountId ?? resolveDefaultBlueBubblesAccountId(cfg)) !== DEFAULT_ACCOUNT_ID$1 ? {
...
const loadBlueBubblesChannelRuntime = createLazyRuntimeNamedExport(() => import("./channel.runtime-QgPA-Gap.js"), "blueBubblesChannelRuntime");
