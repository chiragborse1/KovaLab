import { n as hasConfiguredSecretInput, t as buildSecretInputSchema } from "./secret-input-BpFibtWM.js";
...
const bluebubblesNetworkSchema = z.object({ 
...
const bluebubblesCatchupSchema = z.object({
...
const BlueBubblesChannelConfigSchema = buildChannelConfigSchema(buildCatchallMultiAccountChannelSchema(z.object({
