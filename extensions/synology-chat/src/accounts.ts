...
import { resolveDangerousNameMatchingEnabled } from "getkova/plugin-sdk/dangerous-name-runtime";
import type {
...
/** Extract the channel config from the full Kova config object. */
function getChannelConfig(cfg: KovaConfig): SynologyChatChannelConfig | undefined {
 ...
 */
export function listAccountIds(cfg: KovaConfig): string[] {
...
export function resolveAccount(
  ...
  const envBotName = process.env.KOVA_BOT_NAME ?? "Kova";
