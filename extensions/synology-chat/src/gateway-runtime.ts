import { DEFAULT_ACCOUNT_ID, type KovaConfig } from "getkova/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "getkova/plugin-sdk/webhook-ingress";
