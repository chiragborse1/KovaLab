...
vi.mock("getkova/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("getkova/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("getkova/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("getkova/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("getkova/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("getkova/plugin-sdk/webhook-ingress");
  return {
    ...actual,
