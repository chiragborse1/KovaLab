...
import { normalizeSecretInputString, type SecretInput } from "getkova/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: KovaConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: KovaConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: KovaConfig): string {
