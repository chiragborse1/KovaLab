import { createClaimableDedupe } from "getkova/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: KovaConfig; threadRootId?: string }) {
