import { requireRuntimeConfig, resolveMarkdownTableMode } from "getkova/plugin-sdk/config-runtime";
...
import { loadOutboundMediaFromUrl, type KovaConfig } from "./runtime-api.js";
