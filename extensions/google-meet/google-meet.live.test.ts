...
const LIVE_MEETING = process.env.KOVA_GOOGLE_MEET_LIVE_MEETING?.trim() ?? "";
const CLIENT_ID =
  process.env.KOVA_GOOGLE_MEET_CLIENT_ID?.trim() ?? process.env.GOOGLE_MEET_CLIENT_ID?.trim() ?? "";
const CLIENT_SECRET =
  process.env.KOVA_GOOGLE_MEET_CLIENT_SECRET?.trim() ??
  process.env.GOOGLE_MEET_CLIENT_SECRET?.trim();
const REFRESH_TOKEN =
  process.env.KOVA_GOOGLE_MEET_REFRESH_TOKEN?.trim() ??
  process.env.GOOGLE_MEET_REFRESH_TOKEN?.trim() ??
  "";
const ACCESS_TOKEN =
  process.env.KOVA_GOOGLE_MEET_ACCESS_TOKEN?.trim() ?? process.env.GOOGLE_MEET_ACCESS_TOKEN?.trim();
const EXPIRES_AT = Number(
  process.env.KOVA_GOOGLE_MEET_ACCESS_TOKEN_EXPIRES_AT ??
