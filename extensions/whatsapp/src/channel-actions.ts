...
function areWhatsAppAgentReactionsEnabled(params: { cfg: KovaConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: KovaConfig) {
