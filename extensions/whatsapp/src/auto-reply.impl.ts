export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "getkova/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "getkova/plugin-sdk/reply-runtime";
