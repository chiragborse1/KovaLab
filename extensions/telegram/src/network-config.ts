...
import { isTruthyEnvValue, isWSL2Sync } from "getkova/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "getkova/plugin-sdk/text-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV = "KOVA_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "KOVA_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "KOVA_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable KOVA_TELEGRAM_DNS_RESULT_ORDER
