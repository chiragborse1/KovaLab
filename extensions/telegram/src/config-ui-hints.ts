...
export const telegramChannelConfigUiHints = {
  ...
  streaming: {
    ...
    help: 'Unified Telegram stream preview mode: "off" | "partial" | "block" | "progress" (default: "partial"). Legacy boolean/streamMode keys are detected; run doctor --fix to migrate.',
  },
  "streaming.mode": {
    label: "Telegram Streaming Mode",
  ...
  execApprovals: {
    ...
    help: "Telegram-native exec approval routing and approver authorization. When unset, Kova auto-enables DM-first native approvals if approvers can be resolved for the selected bot account.",
  },
  ...
  "execApprovals.approvers": {
    ...
    help: "Telegram user IDs allowed to approve exec requests for this bot account. Use numeric Telegram user IDs. If you leave this unset, Kova falls back to numeric owner IDs inferred from channels.telegram.allowFrom and direct-message defaultTo when possible.",
  },
