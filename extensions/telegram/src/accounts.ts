...
import {
  ...
  type KovaConfig,
} from "getkova/plugin-sdk/account-core";
import type {
  TelegramAccountConfig,
  TelegramActionConfig,
} from "getkova/plugin-sdk/config-runtime";
import { formatSetExplicitDefaultInstruction } from "getkova/plugin-sdk/routing";
import { createSubsystemLogger, isTruthyEnvValue } from "getkova/plugin-sdk/runtime-env";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.KOVA_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: KovaConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: KovaConfig): string {
...
export function listEnabledTelegramAccounts(cfg: KovaConfig): ResolvedTelegramAccount[] {
