...
export function shouldShowTelegramDmAccessWarning(cfg: KovaConfig, accountId: string): boolean {
...
export function buildTelegramDmAccessWarningLines(accountId: string): string[] {
  ...
  return [
    ...
    "  " + formatCliCommand(`kova config set ${configBase}.dmPolicy "allowlist"`),
    "  " + formatCliCommand(`kova config set ${configBase}.allowFrom '["YOUR_USER_ID"]'`),
