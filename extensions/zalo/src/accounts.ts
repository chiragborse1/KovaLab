...
function mergeZaloAccountConfig(cfg: KovaConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: KovaConfig): ResolvedZaloAccount[] {
