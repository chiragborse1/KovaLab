...
import type { ModelDefinitionConfig } from "getkova/plugin-sdk/provider-onboard";
import { type KovaConfig, withFetchPreconnect } from "getkova/plugin-sdk/testing";
...
describe("Ollama provider", () => {
  const createAgentDir = () => mkdtempSync(join(tmpdir(), "kova-test-"));
  ...
  async function runOllamaCatalog(params: { config?: KovaConfig; env?: NodeJS.ProcessEnv }) {
