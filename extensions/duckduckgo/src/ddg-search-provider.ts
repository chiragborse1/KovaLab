import { readNumberParam, readStringParam } from "getkova/plugin-sdk/param-readers";
import type { WebSearchProviderPlugin } from "getkova/plugin-sdk/provider-web-search-contract";
