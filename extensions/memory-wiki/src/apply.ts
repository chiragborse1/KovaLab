...
const GENERATED_START = "<!-- kova:wiki:generated:start -->";
const GENERATED_END = "<!-- kova:wiki:generated:end -->";
const HUMAN_START = "<!-- kova:human:start -->";
const HUMAN_END = "<!-- kova:human:end -->";
