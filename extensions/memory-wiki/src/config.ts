...
import { mapPluginConfigIssues } from "getkova/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type KovaPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: KovaPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".kova", "wiki", "main");
}
