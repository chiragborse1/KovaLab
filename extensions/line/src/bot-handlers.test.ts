...
vi.mock("getkova/plugin-sdk/channel-inbound", () => ({
  buildMentionRegexes: () => [],
...
vi.mock("getkova/plugin-sdk/channel-pairing", () => ({
...
vi.mock("getkova/plugin-sdk/command-auth", () => ({
...
vi.mock("getkova/plugin-sdk/config-runtime", () => ({
...
vi.mock("getkova/plugin-sdk/group-access", () => ({
...
vi.mock("getkova/plugin-sdk/routing", () => ({
