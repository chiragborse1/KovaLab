...
import { __testing as sessionBindingTesting } from "getkova/plugin-sdk/conversation-runtime";
...
describe("buildLineMessageContext", () => {
  ...
  beforeEach(async () => {
    ...
    tmpDir = await fs.mkdtemp(path.join(os.tmpdir(), "kova-line-context-"));
