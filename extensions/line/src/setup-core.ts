import type { ChannelSetupAdapter, KovaConfig } from "getkova/plugin-sdk/setup";
import { createSetupInputPresenceValidator } from "getkova/plugin-sdk/setup";
...
export function isLineConfigured(cfg: KovaConfig, accountId: string): boolean {
