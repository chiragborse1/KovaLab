...
import { doesApprovalRequestMatchChannelAccount } from "getkova/plugin-sdk/approval-native-runtime";
import type { KovaConfig } from "getkova/plugin-sdk/config-runtime";
import { normalizeStringifiedOptionalString } from "getkova/plugin-sdk/text-runtime";
...
function resolveSlackOwnerApprovers(cfg: KovaConfig): string[] {
