...
function createSlackAccount(config: NonNullable<KovaConfig["channels"]>["slack"]) {
  return {
    accountId: "default",
    enabled: true,
    botToken: "xoxb-test",
...
function createSlashCommandSlackConfig(options: { useAccessGroups?: boolean } = {}): KovaConfig {
  return {
...
async function collectSlackFindingsForConfig(cfg: KovaConfig) {
