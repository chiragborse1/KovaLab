...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<KovaConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<KovaConfig["channels"]>["slack"]>>,
): KovaConfig {
  return {
    channels: {
      slack: {
