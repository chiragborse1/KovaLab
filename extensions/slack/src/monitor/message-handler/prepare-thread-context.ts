import { formatInboundEnvelope } from "getkova/plugin-sdk/channel-inbound";
import type { ContextVisibilityMode } from "getkova/plugin-sdk/config-runtime";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("getkova/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
