...
vi.mock("getkova/plugin-sdk/channel-feedback", () => ({
  DEFAULT_TIMING: {
    doneHoldMs: 0,
    errorHoldMs: 0,
  },
...
vi.mock("getkova/plugin-sdk/channel-reply-pipeline", () => ({
...
vi.mock("getkova/plugin-sdk/channel-streaming", () => ({
...
vi.mock("getkova/plugin-sdk/outbound-runtime", () => ({
  resolveAgentOutboundIdentity: () => undefined,
}));

vi.mock("getkova/plugin-sdk/reply-history", () => ({
  clearHistoryEntriesIfEnabled: () => {},
}));

vi.mock("getkova/plugin-sdk/reply-payload", () => ({
...
vi.mock("getkova/plugin-sdk/text-runtime", () => ({
...
vi.mock("../config.runtime.js", () => ({
  resolveStorePath: () => "/tmp/kova-store.json",
