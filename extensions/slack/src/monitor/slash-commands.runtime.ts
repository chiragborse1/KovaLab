...
type BuildCommandTextFromArgs =
  typeof import("getkova/plugin-sdk/command-auth").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("getkova/plugin-sdk/command-auth").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("getkova/plugin-sdk/command-auth").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("getkova/plugin-sdk/command-auth").parseCommandArgs;
type ResolveCommandArgMenu = typeof import("getkova/plugin-sdk/command-auth").resolveCommandArgMenu;
