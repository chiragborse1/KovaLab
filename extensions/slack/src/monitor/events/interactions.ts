...
// Prefix for Kova-generated action IDs to scope our handler
const KOVA_ACTION_PREFIX = "kova:";
...
export function registerSlackInteractionEvents(params: {
  ...
  const modalMatcher = new RegExp(`^${KOVA_ACTION_PREFIX}`);

  // Handle Kova modal submissions with callback_ids scoped by our prefix.
  registerModalLifecycleHandler({
