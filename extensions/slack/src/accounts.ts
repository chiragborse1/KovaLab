...
export function mergeSlackAccountConfig(cfg: KovaConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: KovaConfig): ResolvedSlackAccount[] {
