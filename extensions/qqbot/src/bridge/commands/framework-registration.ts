...
import type { KovaPluginApi, PluginCommandContext } from "getkova/plugin-sdk/plugin-entry";
...
export function registerQQBotFrameworkCommands(api: KovaPluginApi): void {
