...
import { createApprovalInteractionHandler } from "./gateway.js";
...
describe("createApprovalInteractionHandler approval buttons", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("rejects approval button clicks from users outside the configured approvers", async () => {
    const handler = createApprovalInteractionHandler(account, undefined, {
