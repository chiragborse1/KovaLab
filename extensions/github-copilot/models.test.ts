...
vi.mock("getkova/plugin-sdk/json-store", () => ({
  loadJsonFile,
  saveJsonFile,
}));

vi.mock("getkova/plugin-sdk/state-paths", () => ({
  resolveStateDir: () => "/tmp/kova-state",
}));

import type { ProviderResolveDynamicModelContext } from "getkova/plugin-sdk/core";
...
describe("github-copilot token", () => {
  const cachePath = "/tmp/kova-state/credentials/github-copilot.token.json";
