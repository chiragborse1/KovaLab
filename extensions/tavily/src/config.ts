...
export function resolveTavilySearchConfig(cfg?: KovaConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: KovaConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: KovaConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
