...
import { extractKeywords } from "getkova/plugin-sdk/memory-core-host-engine-qmd";
import {
  readMemoryFile,
...
const MEMORY_INDEX_MANAGER_CACHE_KEY = Symbol.for("kova.memoryIndexManagerCache");
...
export class MemoryIndexManager extends MemoryManagerEmbeddingOps implements MemorySearchManager {
  ...
  protected readonly cfg: KovaConfig;
  ...
  protected async withTimeout<T>(promise: Promise<T>, timeoutMs: number, message: string) {
