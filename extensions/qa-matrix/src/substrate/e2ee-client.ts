...
import type {
  ...
  MessageEventContent,
} from "@kovaai/matrix/test-api.js";
...
type MatrixQaE2eeRuntime = typeof import("@kovaai/matrix/test-api.js");
...
async function loadMatrixQaE2eeRuntime(): Promise<MatrixQaE2eeRuntime> {
  const { loadQaRunnerBundledPluginTestApi } = await import("getkova/plugin-sdk/qa-runner-runtime");
