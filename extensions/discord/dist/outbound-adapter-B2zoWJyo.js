...
async function sendDiscordComponentMessageLazy(...args) {
	discordComponentSendPromise ??= import("./send.components-DRKfQIir.js").then((n) => n.i).then((module) => module.sendDiscordComponentMessage);
...
async function loadDiscordSendRuntime() {
	discordSendRuntimePromise ??= import("./send-DD79oKyT.js").then((n) => n.t);
...
function loadDiscordThreadBindings() {
	discordThreadBindingsPromise ??= import("./thread-bindings-BSa0dQOR.js").then((n) => n.t);
