...
import { j as createDiscordRestClient } from "./send.shared-D0z7Ze6v.js";
import { s as createThreadDiscord } from "./send-DD79oKyT.js";
import { a as sendWebhookMessageDiscord, t as sendMessageDiscord } from "./send.outbound-Dq70cNWg.js";
...
async function createWebhookForChannel(params) {
	try {
		const created = await createDiscordRestClient({
			...
			token: params.token
		}).rest.post(Routes.channelWebhooks(params.channelId), { body: { name: "Kova Agents" } });
