...
import { n as resolveDiscordReplyDeliveryPlan } from "./threading-BwXxHPyd.js";
...
async function loadMessageProcessRuntime() {
	messageProcessRuntimePromise ??= import("./message-handler.process-BTyEjPR8.js");
	return await messageProcessRuntimePromise;
}
async function loadReplyDeliveryRuntime() {
	replyDeliveryRuntimePromise ??= import("./reply-delivery-AD3iLIMp.js").then((n) => n.n);
...
async function loadMessagePreflightRuntime() {
	messagePreflightRuntimePromise ??= import("./message-handler.preflight-BiY0TnNc.js");
