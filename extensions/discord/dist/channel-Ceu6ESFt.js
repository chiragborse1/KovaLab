...
import { t as getDiscordApprovalCapability } from "./approval-native-CFd0T1dO.js";
import { t as discordMessageActions$1 } from "./channel-actions-ffBJW0N5.js";
...
import { i as normalizeDiscordMessagingTarget, n as discordOutbound, r as looksLikeDiscordTargetId } from "./outbound-adapter-B2zoWJyo.js";
import { t as getDiscordRuntime } from "./runtime-DwbCVZGx.js";
import { i as discordSecurityAdapter, n as discordConfigAdapter, r as discordSetupAdapter, t as createDiscordPluginBase } from "./shared-Bzh_unBo.js";
...
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(() => import("./thread-bindings.manager-pFj-j15X.js").then((n) => n.a));
async function loadDiscordProviderRuntime() {
	discordProviderRuntimePromise ??= import("./provider.runtime-DNLAEE42.js");
...
async function loadDiscordAuditModule() {
	discordAuditModulePromise ??= import("./audit-CippomxW.js").then((n) => n.n);
	return await discordAuditModulePromise;
}
async function loadDiscordSendModule() {
	discordSendModulePromise ??= import("./send-DD79oKyT.js").then((n) => n.t);
...
const discordPlugin = createChatChannelPlugin({
	base: {
		...
		agentPrompt: { messageToolHints: () => ["- Discord components: set `components` when sending messages to include buttons, selects, or v2 containers.", "- Forms: add `components.modal` (title, fields). Kova adds a trigger button and routes submissions as new messages."] },
		messaging: {
