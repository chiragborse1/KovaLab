...
import { collectProviderDangerousNameMatchingScopes } from "getkova/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: KovaConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: KovaConfig,
  doctorFixCommand: string,
): { config: KovaConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: KovaConfig): string[] {
