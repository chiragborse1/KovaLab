import { coerceNativeSetting, normalizeAllowFromList } from "getkova/plugin-sdk/channel-policy";
...
} from "getkova/plugin-sdk/native-command-config-runtime";
...
export async function collectDiscordSecurityAuditFindings(params: {
  ...
  addDiscordNameBasedEntries({
    ...
    source: "~/.kova/credentials/discord-allowFrom.json",
  });
