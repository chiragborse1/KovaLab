...
import { resolveMarkdownTableMode } from "getkova/plugin-sdk/markdown-table-runtime";
import { getAgentScopedMediaLocalRoots } from "getkova/plugin-sdk/media-runtime";
import { createNonExitingRuntime, logVerbose } from "getkova/plugin-sdk/runtime-env";
import { resolveOpenProviderRuntimeGroupPolicy } from "getkova/plugin-sdk/runtime-group-policy";
import { logDebug, logError } from "getkova/plugin-sdk/text-runtime";
...
let replyRuntimePromise: Promise<typeof import("getkova/plugin-sdk/reply-runtime")> | undefined;
let replyPipelineRuntimePromise:
  | Promise<typeof import("getkova/plugin-sdk/channel-reply-pipeline")>
  | undefined;
...
async function _loadReplyRuntime() {
  replyRuntimePromise ??= import("getkova/plugin-sdk/reply-runtime");
  return await replyRuntimePromise;
}
async function loadReplyPipelineRuntime() {
  replyPipelineRuntimePromise ??= import("getkova/plugin-sdk/channel-reply-pipeline");
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__kova_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__kova_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__kova_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__kova_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__kova_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__kova_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "Kova form";
  customId = "__kova_discord_component_modal_wildcard__";
  components = [];
