...
import { CHANNEL_APPROVAL_NATIVE_RUNTIME_CONTEXT_CAPABILITY } from "getkova/plugin-sdk/approval-handler-adapter-runtime";
import type { ChannelRuntimeSurface } from "getkova/plugin-sdk/channel-contract";
import { registerChannelRuntimeContext } from "getkova/plugin-sdk/channel-runtime-context";
import {
...
import { createConnectedChannelStatusPatch } from "getkova/plugin-sdk/gateway-runtime";
import { resolveTextChunkLimit } from "getkova/plugin-sdk/reply-chunking";
import {
  danger,
  isVerbose,
  logVerbose,
...
} from "getkova/plugin-sdk/runtime-group-policy";
...
type GetPluginCommandSpecs =
  typeof import("getkova/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
...
let pluginRuntimePromise: Promise<typeof import("getkova/plugin-sdk/plugin-runtime")> | undefined;
...
async function loadPluginRuntime() {
  pluginRuntimePromise ??= import("getkova/plugin-sdk/plugin-runtime");
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("getkova/plugin-sdk/reply-history").HistoryEntry[]
    >();
