...
import * as pluginCommandsModule from "getkova/plugin-sdk/plugin-runtime";
import * as dispatcherModule from "getkova/plugin-sdk/reply-dispatch-runtime";
...
function createCommand(cfg: KovaConfig, discordConfig?: DiscordAccountConfig) {
...
async function runGuildSlashCommand(params?: {
  userId?: string;
  mutateConfig?: (cfg: KovaConfig) => void;
