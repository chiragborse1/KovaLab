...
import { loadJsonFile, saveJsonFile } from "getkova/plugin-sdk/json-store";
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "getkova/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("kova.discordThreadBindingsState");
