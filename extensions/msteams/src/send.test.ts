...
vi.mock("getkova/plugin-sdk/outbound-media", () => ({
...
vi.mock("getkova/plugin-sdk/text-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("getkova/plugin-sdk/text-runtime")>();
  return {
    ...actual,
