...
function resolveKovaVersion(): string {
  try {
 ...
 * and appends the Kova version.
 *
 * Format: "teams.ts[apps]/<sdk-version> Kova/<kova-version>"
 * Example: "teams.ts[apps]/2.0.5 Kova/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} Kova/${resolveKovaVersion()}`;
  return cachedUserAgent;
}
