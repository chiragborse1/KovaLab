...
import { normalizeScpRemoteHost } from "getkova/plugin-sdk/host-runtime";
import { waitForTransportReady } from "getkova/plugin-sdk/infra-runtime";
import { isInboundPathAllowed, kindFromMime } from "getkova/plugin-sdk/media-runtime";
import {
  clearHistoryEntriesIfEnabled,
  DEFAULT_GROUP_HISTORY_LIMIT,
  type HistoryEntry,
} from "getkova/plugin-sdk/reply-history";
import { resolveTextChunkLimit } from "getkova/plugin-sdk/reply-runtime";
import { dispatchInboundMessage } from "getkova/plugin-sdk/reply-runtime";
import { createReplyDispatcher } from "getkova/plugin-sdk/reply-runtime";
import { danger, logVerbose, shouldLogVerbose, warn } from "getkova/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "getkova/plugin-sdk/security-runtime";
import { truncateUtf16Safe } from "getkova/plugin-sdk/text-runtime";
 ...
 *   exec ssh -T kova@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., kova@192.168.64.3)
