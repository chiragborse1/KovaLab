...
vi.mock("getkova/plugin-sdk/hook-runtime", async () => {
  const actual = await vi.importActual<typeof import("getkova/plugin-sdk/hook-runtime")>(
    "getkova/plugin-sdk/hook-runtime",
  );
  return {
    ...actual,
