...
function resolveBrowserBaseUrl(params: {
  ...
  if (!resolved.enabled) {
    throw new Error("Browser control is disabled. Set browser.enabled=true in ~/.kova/kova.json.");
  }
  return undefined;
}
...
export function createBrowserTool(opts?: {
  ...
  return {
    ...
    description: [
      ...
      "Browser choice: omit profile by default for the isolated Kova-managed browser.",
