...
import { resolveConfiguredCapabilityProvider } from "getkova/plugin-sdk/provider-selection-runtime";
...
export class VoiceCallWebhookServer {
  ...
  private fullConfig: KovaConfig | null;
  ...
  private async initializeMediaStreaming(): Promise<void> {
    ...
    const pluginConfig = this.fullConfig ?? (this.coreConfig as unknown as KovaConfig | undefined);
    ...
    const resolution = resolveConfiguredCapabilityProvider({
      ...
      cfg: pluginConfig,
      cfgForResolve: pluginConfig ?? ({} as KovaConfig),
