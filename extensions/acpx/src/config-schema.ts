import { buildPluginConfigSchema } from "getkova/plugin-sdk/core";
import { z } from "getkova/plugin-sdk/zod";
import type { KovaPluginConfigSchema } from "../runtime-api.js";
...
export const AcpxPluginConfigSchema = z.strictObject({
  ...
  kovaToolsMcpBridge: z.boolean({ error: "kovaToolsMcpBridge must be a boolean" }).optional(),
...
export function createAcpxPluginConfigSchema(): KovaPluginConfigSchema {
