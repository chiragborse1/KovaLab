...
[https://github.com/chiragborse1/KovaLab/blob/main/apps/macos/README.md](https://github.com/chiragborse1/KovaLab/blob/main/apps/macos/README.md)
...
1. Reset the TCC permissions:
   ...
   ```bash
   tccutil reset All ai.kova.mac.debug
   ```

2. If that fails, change the `BUNDLE_ID` temporarily in [`scripts/package-mac-app.sh`](https://github.com/chiragborse1/KovaLab/blob/main/scripts/package-mac-app.sh) to force a "clean slate" from macOS.
