...
- Replies are delivered to the **last-used main provider** (WhatsApp/Telegram/Discord/local chat). If delivery fails, the error is logged and the run is still visible via local chat/session logs.
