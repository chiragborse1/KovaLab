...
- Service status: `kova gateway status`

## Gateway service install (CLI)

Use one of these (all supported):

- Wizard (recommended): `kova onboard --install-daemon`
- Direct: `kova gateway install`
- Configure flow: `kova configure` → select **Gateway service**
- Repair/migrate: `kova doctor` (offers to install or fix the service)
