...
<Tabs>
  <Tab title="Quick setup">
    ...
    - Local Gateway on loopback for always-on follow-up work
    ...
    - Chat channel setup is skipped by default; use custom setup or `kova channels add` when you want Kova outside the terminal
  </Tab>
...
4. **Chat channels** — skipped by default in quick setup. Custom setup can configure built-in and bundled chat channels such as BlueBubbles, Discord, Feishu, Google Chat, Mattermost, Microsoft Teams, QQ Bot, Signal, Slack, Telegram, WhatsApp, and more.
