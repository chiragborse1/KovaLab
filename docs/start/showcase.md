...
<Card title="Community showcase reel" href="https://www.youtube.com/watch?v=mMSKQvlmFuQ">
  A faster pass across real projects, surfaces, and workflows built around Kova.
</Card>
...
OpenCode finishes the change, opens a PR, Kova reviews the diff and replies in Telegram with suggestions plus a clear merge verdict.
...
Asked "Robby" (@kovaai) for a local wine cellar skill. It requests a sample CSV export and a store path, then builds and tests the skill (962 bottles in the example).
...
Desktop app to manage skills and commands across Agents, Claude, Codex, and Kova.
...
14+ agents under one gateway with an Opus 4.5 orchestrator delegating to Codex workers. See the [technical write-up](https://github.com/adam91holt/orchestrated-ai-articles) and [Kovaspace](https://github.com/adam91holt/kovaspace) for agent sandboxing.
</Card>

<Card title="Linear CLI" icon="terminal" href="https://github.com/Finesssee/linear-cli">
  **@NessZerra** • `devtools` `linear` `cli`

CLI for Linear that integrates with agentic workflows (Claude Code, Kova). Manage issues, projects, and workflows from the terminal.
</Card>
...
A scheduled prompt generates one scene image each morning (weather, tasks, date, favorite post or quote) via an Kova persona.
</Card>
...
<Card title="Kovaia phone bridge" icon="phone" href="https://github.com/alejandroOPI/kovaia-bridge">
...
Packaging, deployment, and integrations that make Kova easier to run and extend.

<CardGroup cols={2}>

<Card title="Home Assistant add-on" icon="home" href="https://github.com/ngutman/kova-ha-addon">
...
<Card title="Nix packaging" icon="snowflake" href="https://github.com/kova/nix-kova">
  **@kovaai** • `nix` `packaging` `deployment`
...
The physical-world side of Kova: homes, sensors, cameras, vacuums, and other devices.
...
Nix-native home automation with Kova as the interface, plus Grafana dashboards.
...
Full astronomy gear marketplace. Built with and around the Kova ecosystem.
</Card>
