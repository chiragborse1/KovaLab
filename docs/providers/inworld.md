---
summary: "Inworld streaming text-to-speech for Kova replies"
read_when:
...
Inworld is a streaming text-to-speech (TTS) provider. In Kova it
...
Kova posts to Inworld's streaming TTS endpoint, concatenates the
...
<Steps>
  ...
  <Step title="Send a message">
    Send a reply through any connected channel. Kova synthesizes the
...
<AccordionGroup>
  ...
  <Accordion title="Audio outputs">
    ...
    Kova asks Inworld for `OGG_OPUS` so the audio plays as a native
