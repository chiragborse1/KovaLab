---
summary: "Use ElevenLabs speech, Scribe STT, and realtime transcription with Kova"
read_when:
  - You want ElevenLabs text-to-speech in Kova
...
Set `modelId` to `eleven_v3` to use ElevenLabs v3 TTS. Kova keeps
...
Kova sends multipart audio to ElevenLabs `/v1/speech-to-text` with
