---
summary: "Synthetic Slack-class channel plugin for deterministic Kova QA scenarios"
title: "QA channel"
read_when:
...
`qa-channel` is a bundled synthetic message transport for automated Kova QA.
...
- Kova-native orchestration later
