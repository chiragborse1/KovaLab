...
Zalo Personal ships as a bundled plugin in current Kova releases, so normal
...
- `kova pairing list zalouser`
- `kova pairing approve zalouser <code>`
...
- Re-login: `kova channels logout --channel zalouser && kova channels login --channel zalouser`
