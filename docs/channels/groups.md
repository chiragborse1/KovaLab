...
Kova "lives" on your own messaging accounts. There is no separate WhatsApp bot user. If **you** are in a group, Kova can see that group and respond there.
...
By default, Kova prioritizes normal chat behavior and keeps context mostly as received. This means allowlists primarily decide who can trigger actions, not a universal redaction boundary for every quoted or historical snippet.
...
- Pulse runs are skipped for group sessions.
    ...
    list: [
      {
        id: "main",
        groupChat: {
          mentionPatterns: ["@kovaai", "kova", "\\+15555550123"],
          historyLimit: 50,
        },
      },
    ],
