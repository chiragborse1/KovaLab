...
Models are maintained in a separate repo: [vignesh07/kova-formal-models](https://github.com/vignesh07/kova-formal-models).
...
```bash
git clone https://github.com/vignesh07/kova-formal-models
cd kova-formal-models
