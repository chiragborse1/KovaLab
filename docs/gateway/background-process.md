...
- Spawned exec commands receive `KOVA_SHELL=exec` for context-aware shell/profile rules.
...
- `KOVA_BASH_PENDING_MAX_OUTPUT_CHARS`: pending stdout/stderr cap per stream (chars)
