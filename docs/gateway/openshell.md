...
<Warning>
If you edit files on the host outside Kova after the initial seed, the remote sandbox does **not** see those changes. Use `kova sandbox recreate` to re-seed.
</Warning>
...
- [Sandbox CLI](/cli/sandbox) -- `kova sandbox` commands
