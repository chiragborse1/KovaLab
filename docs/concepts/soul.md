---
summary: "Use SOUL.md to give your Kova agent an actual voice instead of generic assistant sludge"
read_when:
...
Kova injects it on normal sessions, so it has real weight. If your agent
...
For Kova, `SOUL.md` is that layer.
...
Path fixed for Kova workspaces: use `SOUL.md`, not `http://SOUL.md`.
