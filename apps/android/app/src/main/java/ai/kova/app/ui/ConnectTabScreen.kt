    ...
    if (showDiagnostics) {
      Surface(
        ...
        Column(
          ...
          if (pairingRequired) {
            Text(
              "Approve this phone on the gateway. Kova retries automatically while this screen stays open.",
              style = mobileCallout,
              color = mobileTextSecondary,
            )
    ...
    AnimatedVisibility(visible = advancedOpen) {
      Surface(
        ...
        Column(
          ...
          CommandBlock("kova qr --setup-code-only")
          CommandBlock("kova qr --json")
          Text(
