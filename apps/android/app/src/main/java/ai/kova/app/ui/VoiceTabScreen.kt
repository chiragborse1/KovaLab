...
import ai.kova.app.VoiceCaptureMode
import ai.kova.app.voice.VoiceConversationEntry
import ai.kova.app.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("Kova is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
