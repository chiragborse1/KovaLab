...
import ai.kova.app.gateway.GatewayClientInfo
import ai.kova.app.gateway.GatewayConnectOptions
import ai.kova.app.gateway.GatewayEndpoint
import ai.kova.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "KovaAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
