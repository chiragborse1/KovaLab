...
import ai.kova.app.ui.mobileAccentBorderStrong
...
import ai.kova.app.ui.mobileSurface
import ai.kova.app.ui.mobileText
import ai.kova.app.ui.mobileTextSecondary
import ai.kova.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.kova.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.kova.app.ui.mobileFontFamily,
