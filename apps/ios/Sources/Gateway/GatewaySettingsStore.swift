...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.kova.gateway"
    private static let nodeService = "ai.kova.node"
    private static let talkService = "ai.kova.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.kova.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.kova.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("kova-gateway.log")
    }
