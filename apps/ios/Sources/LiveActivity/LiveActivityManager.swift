...
final class LiveActivityManager {
    ...
    private var currentActivity: Activity<KovaActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = KovaActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<KovaActivityAttributes>.activities
    ...
    private func updateCurrent(state: KovaActivityAttributes.ContentState) {
    ...
    private func connectingState() -> KovaActivityAttributes.ContentState {
        KovaActivityAttributes.ContentState(
    ...
    private func idleState() -> KovaActivityAttributes.ContentState {
        KovaActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> KovaActivityAttributes.ContentState {
        KovaActivityAttributes.ContentState(
