...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.kova", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Kova/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__kova__/a2ui/").absoluteString + "?platform=macos"
    }
