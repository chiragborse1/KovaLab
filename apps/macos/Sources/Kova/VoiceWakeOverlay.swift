...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.kova", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Kova windows, but below the system’s pop-up menus.
