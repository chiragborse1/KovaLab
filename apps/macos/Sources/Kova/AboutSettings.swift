...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/chiragborse1/KovaLab") {
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "KovaBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "KovaBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "KovaGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "KovaGitCommit") as? String) ??
            "unknown"
    }
