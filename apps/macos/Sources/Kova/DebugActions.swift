...
enum DebugActions {
    private static let verboseDefaultsKey = "kova.debug.verboseMain"
    private static let sessionMenuLimit = 12
    private static let onboardingSeenKey = "kova.onboardingSeen"
    ...
    static func sendTestNotification() async {
        _ = await NotificationManager().send(title: "Kova", body: "Test notification", sound: nil)
    }
    ...
    private static func resolveSessionStorePath() -> String {
        ...
        let configURL = KovaPaths.configURL
        guard
