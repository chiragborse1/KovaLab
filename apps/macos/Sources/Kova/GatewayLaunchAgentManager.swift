...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.kova", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".kova/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.kovaCommand(
            subcommand: "gateway",
