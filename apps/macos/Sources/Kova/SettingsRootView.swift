...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .kovaSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? KovaPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? KovaPaths.stateDirURL.path
...
extension Notification.Name {
    static let kovaSelectSettingsTab = Notification.Name("kovaSelectSettingsTab")
}
