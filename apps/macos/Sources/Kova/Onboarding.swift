...
enum UIStrings {
    static let welcomeTitle = "Welcome to Kova"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "kova.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: KovaChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g kova@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: KovaChatViewModel(
