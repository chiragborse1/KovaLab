...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.kova", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return KovaConfigFile.defaultWorkspaceURL() }
