...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.kova", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        KovaPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        KovaPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
