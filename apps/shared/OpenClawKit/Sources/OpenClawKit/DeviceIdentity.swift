...
enum DeviceIdentityPaths {
    private static let stateDirEnv = ["KOVA_STATE_DIR", "OPENCLAW_STATE_DIR"]
    ...
    static func stateDirURL() -> URL {
        ...
        if let appSupport = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask).first {
            return appSupport.appendingPathComponent("Kova", isDirectory: true)
        }

        return FileManager.default.temporaryDirectory.appendingPathComponent("kova", isDirectory: true)
    }
}
