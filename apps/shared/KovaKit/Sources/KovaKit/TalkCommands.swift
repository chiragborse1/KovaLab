...
public enum KovaTalkCommand: String, Codable, Sendable {
...
public struct KovaTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct KovaTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
