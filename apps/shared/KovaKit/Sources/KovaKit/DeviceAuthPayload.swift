...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: KovaProtocol.AnyCodable]?
    {
        ...
        return [
            "id": KovaProtocol.AnyCodable(identity.deviceId),
            "publicKey": KovaProtocol.AnyCodable(publicKey),
            "signature": KovaProtocol.AnyCodable(signature),
            "signedAt": KovaProtocol.AnyCodable(signedAtMs),
            "nonce": KovaProtocol.AnyCodable(nonce),
        ]
    }
}
