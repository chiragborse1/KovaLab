...
public enum KovaCanvasA2UICommand: String, Codable, Sendable {
...
public struct KovaCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct KovaCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
