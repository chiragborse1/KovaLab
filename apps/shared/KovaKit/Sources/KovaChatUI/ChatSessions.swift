...
public struct KovaChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct KovaChatSessionsDefaults: Codable, Sendable {
...
public struct KovaChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
...
public struct KovaChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: KovaChatSessionsDefaults?
    public let sessions: [KovaChatSessionEntry]
