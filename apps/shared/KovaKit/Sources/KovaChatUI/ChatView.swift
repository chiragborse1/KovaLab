...
@MainActor
public struct KovaChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: KovaChatViewModel
    ...
    private var visibleMessages: [KovaChatMessage] {
        let base: [KovaChatMessage]
    ...
    private func mergeToolResults(in messages: [KovaChatMessage]) -> [KovaChatMessage] {
    ...
    private func isToolResultMessage(_ message: KovaChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func shouldDisplayMessage(_ message: KovaChatMessage) -> Bool {
    ...
    private func primaryText(in message: KovaChatMessage) -> String {
    ...
    private func hasInlineAttachments(in message: KovaChatMessage) -> Bool {
    ...
    private func toolCalls(in message: KovaChatMessage) -> [KovaChatMessageContent] {
    ...
    private func inlineToolResults(in message: KovaChatMessage) -> [KovaChatMessageContent] {
        message.content.filter { content in
            let kind = (content.type ?? "").lowercased()
    ...
    private func toolCallIds(in message: KovaChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: KovaChatMessage) -> String {
