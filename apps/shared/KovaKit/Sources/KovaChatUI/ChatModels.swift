...
public typealias KovaPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias KovaPlatformImage = UIImage
#endif

public struct KovaChatUsageCost: Codable, Hashable, Sendable {
...
public struct KovaChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: KovaChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(KovaChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct KovaChatMessageContent: Codable, Hashable, Sendable {
...
public struct KovaChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [KovaChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: KovaChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [KovaChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: KovaChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(KovaChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([KovaChatMessageContent].self, forKey: .content) {
...
public struct KovaChatHistoryPayload: Codable, Sendable {
...
public struct KovaSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct KovaSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [KovaSessionPreviewItem]
}

public struct KovaSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [KovaSessionPreviewEntry]

    public init(ts: Int, previews: [KovaSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct KovaChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct KovaChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct KovaAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct KovaChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct KovaGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct KovaPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: KovaPlatformImage?
...
public struct KovaChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
