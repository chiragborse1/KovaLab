export declare const GATEWAY_CLIENT_IDS: {
    ...
    readonly MACOS_APP: "kova-macos";
    readonly IOS_APP: "kova-ios";
    readonly ANDROID_APP: "kova-android";
    readonly NODE_HOST: "node-host";
    readonly TEST: "test";
    readonly FINGERPRINT: "fingerprint";
    readonly PROBE: "kova-probe";
};
...
export declare const LEGACY_GATEWAY_CLIENT_IDS: Readonly<Record<string, GatewayClientId>>;
export declare const ACCEPTED_GATEWAY_CLIENT_ID_VALUES: readonly string[];
