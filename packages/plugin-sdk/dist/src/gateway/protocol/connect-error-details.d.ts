export declare const ConnectErrorDetailCodes: {
    ...
    readonly OPERATOR_CLIENT_ORIGIN_NOT_ALLOWED: "OPERATOR_CLIENT_ORIGIN_NOT_ALLOWED";
    readonly OPERATOR_CLIENT_DEVICE_IDENTITY_REQUIRED: "OPERATOR_CLIENT_DEVICE_IDENTITY_REQUIRED";
