...
export declare const WizardStartParamsSchema: Type.TObject<{
    flow: Type.TOptional<Type.TUnion<[Type.TLiteral<"onboard">, Type.TLiteral<"configure">]>>;
    mode: Type.TOptional<Type.TUnion<[Type.TLiteral<"local">, Type.TLiteral<"remote">]>>;
    section: Type.TOptional<Type.TUnion<[Type.TLiteral<"workspace">, Type.TLiteral<"model">, Type.TLiteral<"web">, Type.TLiteral<"gateway">, Type.TLiteral<"daemon">, Type.TLiteral<"channels">, Type.TLiteral<"plugins">, Type.TLiteral<"skills">, Type.TLiteral<"health">]>>;
...
export declare const WizardStepSchema: Type.TObject<{
    ...
    imageDataUrl: Type.TOptional<Type.TString>;
    primaryLabel: Type.TOptional<Type.TString>;
    secondaryLabel: Type.TOptional<Type.TString>;
    dangerLabel: Type.TOptional<Type.TString>;
