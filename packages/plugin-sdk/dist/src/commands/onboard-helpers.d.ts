...
export declare function formatWizardBootScreen(): string;
...
export declare const LEGACY_DEFAULT_WORKSPACE: string;
export declare function resolveOnboardWorkspaceDefault(config: OpenClawConfig): string;
