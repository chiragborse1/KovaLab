...
export declare const AGENT_CLEANUP_STEP_TIMEOUT_ENV = "KOVA_AGENT_CLEANUP_TIMEOUT_MS";
export declare const TRAJECTORY_FLUSH_TIMEOUT_ENV = "KOVA_TRAJECTORY_FLUSH_TIMEOUT_MS";
