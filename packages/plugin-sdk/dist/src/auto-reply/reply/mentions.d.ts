...
export declare function buildMentionRegexes(cfg: KovaConfig | undefined, agentId?: string): RegExp[];
...
export declare function stripMentions(text: string, ctx: MsgContext, cfg: KovaConfig | undefined, agentId?: string): string;
