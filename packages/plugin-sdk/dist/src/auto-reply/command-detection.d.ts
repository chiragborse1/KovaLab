...
export declare function hasControlCommand(text?: string, cfg?: KovaConfig, options?: CommandNormalizeOptions): boolean;
export declare function isControlCommandMessage(text?: string, cfg?: KovaConfig, options?: CommandNormalizeOptions): boolean;
/**
...
export declare function shouldComputeCommandAuthorized(text?: string, cfg?: KovaConfig, options?: CommandNormalizeOptions): boolean;
