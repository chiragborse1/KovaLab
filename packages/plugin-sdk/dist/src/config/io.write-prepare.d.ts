...
export declare function unsetPathForWrite(root: KovaConfig, pathSegments: string[]): {
    changed: boolean;
    next: KovaConfig;
};
export declare function applyUnsetPathsForWrite(root: KovaConfig, unsetPaths: readonly string[][] | undefined): KovaConfig;
