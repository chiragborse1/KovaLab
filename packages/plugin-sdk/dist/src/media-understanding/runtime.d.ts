...
export declare function describeImageFileWithModel(params: DescribeImageFileWithModelParams): Promise<import("getkova/plugin-sdk/media-understanding").ImageDescriptionResult>;
