...
export declare function resolveCapabilityConfig(cfg: KovaConfig, capability: MediaUnderstandingCapability): MediaUnderstandingConfig | undefined;
...
export declare function resolveConcurrency(cfg: KovaConfig): number;
