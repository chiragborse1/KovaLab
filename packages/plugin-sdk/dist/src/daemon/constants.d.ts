export declare const GATEWAY_LAUNCH_AGENT_LABEL = "ai.kova.gateway";
export declare const GATEWAY_SYSTEMD_SERVICE_NAME = "kova-gateway";
export declare const GATEWAY_WINDOWS_TASK_NAME = "Kova Gateway";
export declare const GATEWAY_SERVICE_MARKER = "kova";
export declare const GATEWAY_SERVICE_KIND = "gateway";
export declare const NODE_LAUNCH_AGENT_LABEL = "ai.kova.node";
export declare const NODE_SYSTEMD_SERVICE_NAME = "kova-node";
export declare const NODE_WINDOWS_TASK_NAME = "Kova Node";
export declare const NODE_SERVICE_MARKER = "kova";
...
export declare const LEGACY_GATEWAY_SERVICE_MARKERS: string[];
...
export declare function resolveLegacyGatewayLaunchAgentLabels(_profile?: string): string[];
export declare function resolveLegacyGatewaySystemdServiceNames(_profile?: string): string[];
...
export declare function isGatewayServiceMarker(value?: string): boolean;
