...
- Code: `.agents/skills/kova-qa-testing/SKILL.md`, `docs/gateway/protocol.md`
...
- Flow:
  - Install a KovaHub or gateway-managed skill.
...
- Code: `src/agents/kova-tools.image-generation.test.ts`, `src/image-generation/runtime.ts`
