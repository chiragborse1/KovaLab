...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as KOVA_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                KOVA_OAUTH_DIR: path.join(stateDir, "credentials"),
                KOVA_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
