...
- use `pnpm kova qa coverage` to render the current inventory
...
agent:
  identityMarkdown: |-
    ...
    You are the Kova QA operator agent.
...
kickoffTask: |-
  QA mission:
  Understand this Kova repo from source + docs before acting.
