...
execution:
  ...
  config:
    firstPrompt: "@kovaai Reconnect dedupe setup marker. Reply exactly: RECONNECT-FIRST-OK"
    secondPrompt: "@kovaai Reconnect dedupe follow-up marker. Reply exactly: RECONNECT-SECOND-OK"
