...
const WORKER_RUNTIME_STATE = Symbol.for("kova.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("kova.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("kova.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: KovaConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
