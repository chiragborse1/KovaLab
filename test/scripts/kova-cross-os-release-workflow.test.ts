...
const WORKFLOW_PATH = ".github/workflows/kova-cross-os-release-checks-reusable.yml";
const HARNESS = "bash workflow/scripts/github/run-kova-cross-os-release-checks.sh";
