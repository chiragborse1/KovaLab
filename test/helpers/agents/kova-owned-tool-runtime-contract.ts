...
export function installKovaOwnedToolHooks(params?: {
 ...
 * Pair with `installKovaOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetKovaOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
