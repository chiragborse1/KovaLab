...
type LoginOpenAICodexOAuth =
  (typeof import("getkova/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
type GithubCopilotLoginCommand =
  (typeof import("getkova/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
...
type EnsureAuthProfileStore =
  typeof import("getkova/plugin-sdk/provider-auth").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("getkova/plugin-sdk/provider-auth").listProfilesForProvider;
...
vi.mock("getkova/plugin-sdk/provider-auth-login", async () => {
  const actual = await vi.importActual<typeof import("getkova/plugin-sdk/provider-auth-login")>(
    "getkova/plugin-sdk/provider-auth-login",
  );
  return {
    ...actual,
...
vi.mock("getkova/plugin-sdk/provider-auth", async () => {
  const actual = await vi.importActual<typeof import("getkova/plugin-sdk/provider-auth")>(
    "getkova/plugin-sdk/provider-auth",
  );
  return {
    ...actual,
