...
const providerFilter = parseCsvFilter(process.env.KOVA_LIVE_IMAGE_GENERATION_PROVIDERS);
const caseFilter = parseCaseFilter(process.env.KOVA_LIVE_IMAGE_GENERATION_CASES);
const envModelMap = parseProviderModelMap(process.env.KOVA_LIVE_IMAGE_GENERATION_MODELS);
