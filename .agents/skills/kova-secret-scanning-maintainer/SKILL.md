---
name: kova-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve Kova GitHub Secret Scanning alerts in issues or PRs.
---
...
Use this skill when processing alerts from `https://github.com/chiragborse1/KovaLab/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/kova-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/chiragborse1/KovaLab/issues/63101#issuecomment-xxx",
