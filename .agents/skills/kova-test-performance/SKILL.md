---
name: kova-test-performance
description: Benchmark, diagnose, and optimize Kova test runtime, import hotspots, CPU/RSS, and slow coverage paths.
---
...
2. Establish a baseline before changing code:
   ...
   - For import-heavy suspicion add:
     `KOVA_VITEST_IMPORT_DURATIONS=1 KOVA_VITEST_PRINT_IMPORT_BREAKDOWN=1`.
...
timeout 240 /usr/bin/time -l env \
  KOVA_VITEST_IMPORT_DURATIONS=1 \
  KOVA_VITEST_PRINT_IMPORT_BREAKDOWN=1 \
