---
name: optimizetests
description: Optimize Kova slow tests, imports, misplaced coverage, and CI wall time without dropping coverage.
---

# Optimize Tests

Goal: real Kova test/runtime speedups with coverage intact. Do not add shards,
...
2. Establish evidence before edits:
   ...
   - Import suspicion: add `KOVA_VITEST_IMPORT_DURATIONS=1 KOVA_VITEST_PRINT_IMPORT_BREAKDOWN=1`
