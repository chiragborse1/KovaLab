---
name: kova-ghsa-maintainer
description: Inspect, patch, validate, publish, or confirm Kova GHSA security advisories and private-fork state.
---

# Kova GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `kova-release-maintainer`.
...
```bash
fork=$(gh api /repos/chiragborse1/KovaLab/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/chiragborse1/KovaLab/security-advisories/<GHSA> \
