...
description: Triage Kova security advisories, drafts, and GHSA reports with shipped-tag and trust-model proof.
---
...
1. Read `SECURITY.md`.
2. Read the GHSA body with `gh api /repos/chiragborse1/KovaLab/security-advisories/<GHSA>`.
...
```bash
gh api /repos/chiragborse1/KovaLab/security-advisories/<GHSA>
gh api /repos/chiragborse1/KovaLab/security-advisories --paginate
git tag --sort=-creatordate | head -n 20
npm view kova version --userconfig "$(mktemp)"
git tag --contains <commit>
git show <tag>:<path>
gh search issues --repo chiragborse1/KovaLab --match title,body,comments -- "<terms>"
gh search prs --repo chiragborse1/KovaLab --match title,body,comments -- "<terms>"
```
