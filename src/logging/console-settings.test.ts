...
let originalKovaTestConsole: string | undefined;
...
beforeEach(() => {
  ...
  originalKovaTestConsole = process.env.KOVA_TEST_CONSOLE;
  process.env.KOVA_TEST_CONSOLE = "1";
...
afterEach(() => {
  ...
  if (originalKovaTestConsole === undefined) {
    delete process.env.KOVA_TEST_CONSOLE;
  } else {
    process.env.KOVA_TEST_CONSOLE = originalKovaTestConsole;
  }
