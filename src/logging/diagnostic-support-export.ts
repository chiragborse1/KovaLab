...
const SUPPORT_EXPORT_PREFIX = "kova-diagnostics-";
...
function readStabilityBundle(
  ...
  if (target === false) {
    return { status: "missing", dir: "$KOVA_STATE_DIR/logs/stability" };
  }
...
function renderSummary(params: {
  ...
  return [
    ...
    "- `logs/kova-sanitized.jsonl`: sanitized log summaries and metadata",
