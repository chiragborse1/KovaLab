...
export function isAcpEnabledByPolicy(cfg: KovaConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: KovaConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: KovaConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: KovaConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: KovaConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: KovaConfig, agentId: string): boolean {
