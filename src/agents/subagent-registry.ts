...
const STALE_ACTIVE_SUBAGENT_GRACE_MS = process.env.KOVA_TEST_FAST === "1" ? 1_000 : 60_000;
...
async function resolveSubagentRegistryContextEngine(cfg: KovaConfig) {
...
function resolveSubagentWaitTimeoutMs(cfg: KovaConfig, runTimeoutSeconds?: number) {
