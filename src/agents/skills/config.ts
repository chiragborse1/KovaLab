...
export function isConfigPathTruthy(config: KovaConfig | undefined, pathStr: string): boolean {
...
const BUNDLED_SOURCES = new Set(["kova-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(resolveSkillSource(entry.skill));
}

export function resolveBundledAllowlist(config?: KovaConfig): string[] | undefined {
