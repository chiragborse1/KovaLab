...
export function resolveSubagentToolPolicy(cfg?: KovaConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: KovaConfig["tools"]): string[] | undefined {
