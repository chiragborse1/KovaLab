...
const SESSION_MCP_RUNTIME_MANAGER_KEY = Symbol.for("kova.sessionMcpRuntimeManager");
...
function resolveSessionMcpRuntimeIdleTtlMs(cfg?: KovaConfig): number {
