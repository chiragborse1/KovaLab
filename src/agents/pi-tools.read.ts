...
function resolveAdaptiveReadMaxBytes(options?: KovaReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createKovaReadTool(base, {
...
export function createKovaReadTool(
  base: AnyAgentTool,
  options?: KovaReadToolOptions,
): AnyAgentTool {
  return {
    ...base,
