...
function createSandboxContext(overrides?: Partial<SandboxContext>): SandboxContext {
  const base = {
    ...
    workspaceDir: "/tmp/kova-sandbox",
    agentWorkspaceDir: "/tmp/kova-workspace",
    workspaceAccess: "none",
    runtimeId: "kova-sbx-test",
    runtimeLabel: "kova-sbx-test",
    containerName: "kova-sbx-test",
    ...
    browser: {
      ...
      containerName: "kova-sbx-browser-test",
    },
