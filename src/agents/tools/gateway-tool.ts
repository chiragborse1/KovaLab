...
function assertGatewayConfigMutationAllowed(params: {
  ...
  const currentFlags = new Set(
    collectEnabledInsecureOrDangerousFlags(params.currentConfig as KovaConfig),
  );
  const nextFlags = collectEnabledInsecureOrDangerousFlags(nextConfig as KovaConfig);
...
export function createGatewayTool(opts?: {
  ...
  return {
    label: "Gateway",
    name: "gateway",
    ownerOnly: isKovaOwnerOnlyCoreToolName("gateway"),
    description:
