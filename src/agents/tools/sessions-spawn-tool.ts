...
// Keep the schema local to avoid a circular import through acp-spawn/kova-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: KovaConfig }) {
