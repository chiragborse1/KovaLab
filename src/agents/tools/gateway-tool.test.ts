...
const formatDoctorNonInteractiveHintMock = vi.fn(() => "Run: kova doctor --non-interactive");
...
describe("gateway tool restart continuation", () => {
  beforeEach(() => {
    ...
    formatDoctorNonInteractiveHintMock.mockReturnValue("Run: kova doctor --non-interactive");
