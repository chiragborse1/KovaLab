import {
  ...
  SKILL_VIEW_TOOL_DISPLAY_SUMMARY,
  SKILLS_LIST_TOOL_DISPLAY_SUMMARY,
...
const CORE_TOOL_DEFINITIONS: CoreToolDefinition[] = [
  ...
  },
  {
    id: "skills_list",
    label: "skills_list",
    description: SKILLS_LIST_TOOL_DISPLAY_SUMMARY,
    sectionId: "skills",
    profiles: ["coding"],
    includeInKovaGroup: true,
  },
  {
    id: "skill_view",
    label: "skill_view",
    description: SKILL_VIEW_TOOL_DISPLAY_SUMMARY,
    sectionId: "skills",
    profiles: ["coding"],
    includeInKovaGroup: true,
  },
...
function buildCoreToolGroupMap() {
  ...
  const kovaTools = CORE_TOOL_DEFINITIONS.filter((tool) => tool.includeInKovaGroup).map(
    (tool) => tool.id,
  );
  return {
    "group:kova": kovaTools,
