...
function resolveMainSessionKeyForSandbox(params: { cfg?: KovaConfig; agentId: string }): string {
...
export function resolveSandboxRuntimeStatus(params: { cfg?: KovaConfig; sessionKey?: string }): {
  agentId: string;
  sessionKey: string;
