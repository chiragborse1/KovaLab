...
export const DEFAULT_SANDBOX_IMAGE = "kova-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "kova-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "kova-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "kova-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "kova-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "kova-sandbox-browser";
