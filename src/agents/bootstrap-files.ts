...
export const FULL_BOOTSTRAP_COMPLETED_CUSTOM_TYPE = "kova:bootstrap-context:full";
...
export function resolveContextInjectionMode(config?: KovaConfig): AgentContextInjection {
