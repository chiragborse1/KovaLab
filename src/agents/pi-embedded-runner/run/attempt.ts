...
import { resolveKovaReferencePaths } from "../../docs-path.js";
...
import { createKovaCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
import {
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const kovaReferences = await resolveKovaReferencePaths({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      // DefaultResourceLoader.reload() rehydrates settings from disk and can drop Kova
      ...
      // exact Kova-managed registrations so custom tools survive startup and
      ...
      try {
        ...
        // double-compaction. See: https://github.com/chiragborse1/KovaLab/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("kova:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/chiragborse1/KovaLab/issues/8643
