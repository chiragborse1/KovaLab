...
export function resolveScopedChannelMediaMaxBytes(params: {
  cfg: KovaConfig;
  accountId?: string | null;
  resolveChannelLimitMb: (params: { cfg: KovaConfig; accountId: string }) => number | undefined;
}): number | undefined {
...
export function createScopedChannelMediaMaxBytesResolver(channel: string) {
  return (params: { cfg: KovaConfig; accountId?: string | null }) =>
...
>(params: {
  ...
  resolveMaxBytes: (params: { cfg: KovaConfig; accountId?: string | null }) => number | undefined;
