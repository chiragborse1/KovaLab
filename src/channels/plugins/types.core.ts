...
export type ChannelAgentToolFactory = (params: { cfg?: KovaConfig }) => ChannelAgentTool[];
...
export type ChannelMessagingAdapter = {
  ...
  enableInteractiveReplies?: (params: { cfg: KovaConfig; accountId?: string | null }) => boolean;
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: KovaConfig; accountId?: string | null }) => string[];
