...
export function createAccountListHelpers(
  ...
  function resolveConfiguredDefaultAccountId(cfg: KovaConfig): string | undefined {
  ...
  function listAccountIds(cfg: KovaConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: KovaConfig): string {
