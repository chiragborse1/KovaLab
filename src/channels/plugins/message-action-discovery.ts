...
export function listChannelMessageActions(cfg: KovaConfig): ChannelMessageActionName[] {
...
export function listChannelMessageCapabilities(cfg: KovaConfig): ChannelMessageCapability[] {
