...
export type ChannelSetupAdapter = {
  ...
  applyAccountName?: (params: { cfg: KovaConfig; accountId: string; name?: string }) => KovaConfig;
...
export type ChannelConfigAdapter<ResolvedAccount> = {
  ...
  deleteAccount?: (params: { cfg: KovaConfig; accountId: string }) => KovaConfig;
  ...
  isConfigured?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: KovaConfig) => boolean | Promise<boolean>
  >;
  unconfiguredReason?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: KovaConfig) => string
  >;
  describeAccount?: ChannelAdapterCallback<
    (account: ResolvedAccount, cfg: KovaConfig) => ChannelAccountSnapshot
  >;
  ...
  hasConfiguredState?: (params: { cfg: KovaConfig; env?: NodeJS.ProcessEnv }) => boolean;
  hasPersistedAuthState?: (params: { cfg: KovaConfig; env?: NodeJS.ProcessEnv }) => boolean;
  resolveDefaultTo?: (params: { cfg: KovaConfig; accountId?: string | null }) => string | undefined;
};
...
export type ChannelStatusAdapter<ResolvedAccount, Probe = unknown, Audit = unknown> = {
  ...
  probeAccount?: ChannelAdapterCallback<
    (params: { account: ResolvedAccount; timeoutMs: number; cfg: KovaConfig }) => Promise<Probe>
  >;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.neuralstudio.in/plugins/building-plugins | Plugin SDK documentation}
   */
...
export type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  resolveGatewayAuthBypassPaths?: (params: { cfg: KovaConfig }) => string[];
...
export type ChannelDoctorAdapter = {
  ...
  normalizeCompatibilityConfig?: (params: { cfg: KovaConfig }) => ChannelDoctorConfigMutation;
  collectPreviewWarnings?: (params: {
    cfg: KovaConfig;
    doctorFixCommand: string;
  }) => string[] | Promise<string[]>;
  collectMutableAllowlistWarnings?: (params: { cfg: KovaConfig }) => string[] | Promise<string[]>;
  repairConfig?: (params: {
    cfg: KovaConfig;
    doctorFixCommand: string;
...
export type ChannelApprovalDeliveryAdapter = {
  hasConfiguredDmRoute?: (params: { cfg: KovaConfig }) => boolean;
...
export type ChannelAllowlistAdapter = {
  applyConfigEdit?: (params: {
    ...
    | Promise<
      ...
      >
    | null;
  readConfig?: (params: { cfg: KovaConfig; accountId?: string | null }) =>
    | {
...
export type ChannelConversationBindingSupport = {
  ...
  createManager?: (params: { cfg: KovaConfig; accountId?: string | null }) =>
    | {
