...
type FacadeModule = {
  findMatrixAccountEntry: (cfg: KovaConfig, accountId: string) => Record<string, unknown> | null;
  getMatrixScopedEnvVarNames: (accountId: string) => MatrixScopedEnvVarNames;
  requiresExplicitMatrixDefaultAccount: (cfg: KovaConfig, env?: NodeJS.ProcessEnv) => boolean;
  resolveConfiguredMatrixAccountIds: (cfg: KovaConfig, env?: NodeJS.ProcessEnv) => string[];
  ...
  resolveMatrixChannelConfig: (cfg: KovaConfig) => Record<string, unknown> | null;
  ...
  resolveMatrixDefaultOrOnlyAccountId: (cfg: KovaConfig, env?: NodeJS.ProcessEnv) => string;
