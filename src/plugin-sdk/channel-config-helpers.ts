...
type ChannelConfigAccessorParams<Config extends KovaConfig = KovaConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends KovaConfig = KovaConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends KovaConfig = KovaConfig>(
...
function setTopLevelChannelEnabledInConfigSection<Config extends KovaConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends KovaConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends KovaConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
