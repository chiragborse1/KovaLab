...
export function resolveSessionToolsVisibility(cfg: KovaConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: KovaConfig): "spawned" | "all" {
  return cfg.agents?.defaults?.sandbox?.sessionToolsVisibility ?? "spawned";
}

export function createAgentToAgentPolicy(cfg: KovaConfig): AgentToAgentPolicy {
