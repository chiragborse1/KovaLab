...
const shouldWarnCompatImport =
  ...
  process.env.KOVA_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "getkova/plugin-sdk/compat is deprecated for new plugins. Migrate to focused getkova/plugin-sdk/<subpath> imports. See https://docs.neuralstudio.in/plugins/sdk-migration",
    {
      code: "KOVA_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.neuralstudio.in/plugins/sdk-migration",
    },
  );
}
