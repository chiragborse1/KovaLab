...
const KOVA_SOURCE_EXTENSIONS_ROOT = path.resolve(KOVA_PACKAGE_ROOT, "extensions");
...
const facadeActivationCheckRuntimeJitiLoaders: PluginJitiLoaderCache =
  createPluginJitiLoaderCache();
...
function buildFacadeActivationCheckParams(
  ...
  return {
    ...params,
    location,
    sourceExtensionsRoot: KOVA_SOURCE_EXTENSIONS_ROOT,
    resolutionKey: createFacadeResolutionKey(params),
  };
}
