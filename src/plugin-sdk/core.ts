...
import type { KovaPluginApi } from "../plugins/types.js";
...
export type { KovaPluginToolContext, KovaPluginToolFactory } from "../plugins/types.js";
export type {
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: KovaConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
