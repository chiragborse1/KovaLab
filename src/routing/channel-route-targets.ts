...
function listConfiguredChannelIds(cfg: KovaConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: KovaConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: KovaConfig): ChannelRouteTarget[] {
