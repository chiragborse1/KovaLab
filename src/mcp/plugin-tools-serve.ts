/**
 * Standalone MCP server that exposes Kova plugin-registered tools
...
function resolveTools(config: KovaConfig): AnyAgentTool[] {
...
export function createPluginToolsMcpServer(
  ...
  return createToolsMcpServer({ name: "kova-plugin-tools", tools });
}
