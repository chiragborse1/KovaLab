...
export function createConfigWriteAuditRecordBase(params: {
  ...
  return {
    ...
    watchMode: params.env.KOVA_WATCH_MODE === "1",
    watchSession: normalizeAuditLabel(params.env.KOVA_WATCH_SESSION),
    watchCommand: normalizeAuditLabel(params.env.KOVA_WATCH_COMMAND),
