...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.webchat.chatHistoryMaxChars": "Local Chat History Max Chars",
  nodeHost: "Node Host",
  ...
  "agents.defaults.pulse.includeSystemPromptSection": "Pulse Include System Prompt Section",
  "agents.list.*.pulse.includeSystemPromptSection": "Pulse Include System Prompt Section",
  "agents.defaults.pulse.directPolicy": "Pulse Direct Policy",
  "agents.list.*.pulse.directPolicy": "Pulse Direct Policy",
  "agents.defaults.pulse.suppressToolErrorWarnings": "Pulse Suppress Tool Error Warnings",
  "agents.list.*.pulse.suppressToolErrorWarnings": "Pulse Suppress Tool Error Warnings",
  "agents.defaults.pulse.timeoutSeconds": "Pulse Timeout (Seconds)",
  "agents.list.*.pulse.timeoutSeconds": "Pulse Timeout (Seconds)",
  ...
  "agents.list[].pulse.suppressToolErrorWarnings": "Agent Pulse Suppress Tool Error Warnings",
  "agents.list[].pulse.timeoutSeconds": "Agent Pulse Timeout (Seconds)",
