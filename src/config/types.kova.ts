...
export type KovaConfig = {
  $schema?: string;
  meta?: {
    /** Last Kova version that wrote this config. */
  ...
  ui?: {
    /** Accent color for Kova UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
declare const kovaConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = KovaConfig & {
  readonly [kovaConfigStateBrand]?: TState;
};
