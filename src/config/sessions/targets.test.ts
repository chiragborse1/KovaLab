...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): KovaConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: KovaConfig, env: NodeJS.ProcessEnv) =>
