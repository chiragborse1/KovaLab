...
export function applyMessageDefaults(cfg: KovaConfig): KovaConfig {
...
export function applyTalkConfigNormalization(config: KovaConfig): KovaConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: KovaConfig): KovaConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: KovaConfig): KovaConfig {
...
export function applyLoggingDefaults(cfg: KovaConfig): KovaConfig {
...
function hasAnthropicDefaultSignal(cfg: KovaConfig, env: NodeJS.ProcessEnv): boolean {
...
export function applyContextPruningDefaults(cfg: KovaConfig): KovaConfig {
...
export function applyCompactionDefaults(cfg: KovaConfig): KovaConfig {
