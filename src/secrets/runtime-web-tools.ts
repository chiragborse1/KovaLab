...
type FetchConfig = NonNullable<KovaConfig["tools"]>["web"] extends infer Web
...
function hasPluginScopedWebToolConfig(config: KovaConfig, key: "webSearch" | "webFetch"): boolean {
