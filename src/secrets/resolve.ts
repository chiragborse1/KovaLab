...
function resolveResolutionLimits(config: KovaConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: KovaConfig): SecretProviderConfig {
