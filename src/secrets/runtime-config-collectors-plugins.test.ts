...
function makeContext(sourceConfig: KovaConfig): ResolverContext {
...
function collectAcpxConfigAssignments(config: KovaConfig): ResolverContext {
...
function expectInactiveAcpxConfig(config: KovaConfig): void {
