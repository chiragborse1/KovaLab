...
export function listAuthProfileStorePaths(config: KovaConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: KovaConfig, stateDir: string): string[] {
