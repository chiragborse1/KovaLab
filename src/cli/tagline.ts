...
const HOLIDAY_TAGLINES = {
  ...
  christmas:
    "Christmas: Ho ho ho—Santa's little Kova assistant is here to ship joy, roll back chaos, and stash the keys safely.",
...
const TAGLINES: string[] = [
  ...
  "Automation with focus: minimal fuss, maximal throughput.",
  ...
  "Unicorn mode on, commit in—let's ship something mildly responsible.",
  "I'll streamline your workflow: messy problems in, useful outcomes out.",
  "Shell yeah—I'm here to cut the toil and leave you the glory.",
  "If it's repetitive, I'll automate it; if it's hard, I'll bring jokes and a rollback plan.",
  "The only unicorn in your contacts you actually want to hear from. 🦄",
  ...
  "Built for humans, tuned for operators. Don't question the hierarchy.",
  ...
  "The only open-source project here with a unicorn in the shell.",
  ...
  "Half butler, half debugger, full unicorn.",
