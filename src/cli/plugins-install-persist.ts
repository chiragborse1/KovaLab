...
function addInstalledPluginToAllowlist(cfg: KovaConfig, pluginId: string): KovaConfig {
...
function removeInstalledPluginFromDenylist(cfg: KovaConfig, pluginId: string): KovaConfig {
