...
function resolveSnapshotRuntimeConfig(snapshot: ConfigFileSnapshot | null): KovaConfig | null {
...
function coerceStatusConfig(value: unknown): KovaConfig {
