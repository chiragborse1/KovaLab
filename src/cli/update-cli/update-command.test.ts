...
describe("resolveGatewayInstallEntrypointCandidates", () => {
  it("prefers index.js before legacy entry.js", () => {
    expect(resolveGatewayInstallEntrypointCandidates("/tmp/kova-root")).toEqual([
      path.join("/tmp/kova-root", "dist", "index.js"),
      path.join("/tmp/kova-root", "dist", "index.mjs"),
      path.join("/tmp/kova-root", "dist", "entry.js"),
      path.join("/tmp/kova-root", "dist", "entry.mjs"),
    ]);
  });
});
