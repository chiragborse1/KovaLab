...
>[] = [
  ...withProgramOnlySpecs(
    defineImportedProgramCommandGroupSpecs([
      ...
      },
      {
        ...
        loadModule: () => import("./register.settings.js"),
        exportName: "registerSettingsCommand",
      },
      {
        commandNames: ["config"],
      ...
      {
        commandNames: ["doctor", "control-ui", "reset", "uninstall"],
    ...
    defineImportedProgramCommandGroupSpecs([
      {
        ...
        loadModule: () => import("./register.persona.js"),
  ...
  ...withProgramOnlySpecs(
    defineImportedProgramCommandGroupSpecs([
      {
        commandNames: ["status", "health", "sessions", "tasks", "goals"],
