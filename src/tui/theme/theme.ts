...
function isLightBackground(): boolean {
  const explicit = normalizeOptionalLowercaseString(process.env.KOVA_THEME);
  if (explicit === "light") {
    return true;
  }
  if (explicit === "dark") {
...
export const darkPalette = {
  ...
  border: KOVA_ORANGE,
  assistantBorder: KOVA_ORANGE,
  assistantTitle: KOVA_ORANGE_SOFT,
  userBorder: "#59D7D7",
  userTitle: "#7DD3A5",
  userBg: "#2B2F36",
  userText: "#F3EEE0",
...
export const lightPalette = {
  ...
  accentSoft: "#B45309",
  border: "#C84F00",
  assistantBorder: "#C84F00",
  assistantTitle: "#B45309",
  userBorder: "#0F766E",
  userTitle: "#047857",
  userBg: "#F3F0E8",
  userText: "#1E1E1E",
...
export const theme = {
  ...
  userTitle: (text: string) => chalk.bold(fg(palette.userTitle)(text)),
