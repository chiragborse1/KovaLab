...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("kova.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("kova.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: KovaConfig): Promise<ContextEngine> {
