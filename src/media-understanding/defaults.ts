...
const configRegistryCache = new WeakMap<KovaConfig, Map<string, MediaUnderstandingProvider>>();

function resolveDefaultRegistry(cfg?: KovaConfig) {
  if (!cfg) {
...
function resolveConfiguredImageProviderIds(cfg?: KovaConfig): string[] {
