...
describe("local media roots", () => {
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "kova-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "kova-agent-media-roots-state"),
  ...
  it.each([
    {
      ...
      stateDir: path.join("/tmp", "kova-flexible-media-roots-state"),
      cfg: {},
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "kova-messaging-media-roots-state"),
    ...
    },
    {
      ...
      stateDir: path.join("/tmp", "kova-messaging-fs-media-roots-state"),
      cfg: {
        tools: {
          profile: "messaging",
  ...
  it("keeps the config-dir media cache root when state and config paths differ", () => {
    const stateDir = path.join("/tmp", "kova-legacy-state");
    const configDir = path.join("/tmp", "kova-current-config");
