...
export function resolveConfiguredMediaMaxBytes(cfg?: KovaConfig): number | undefined {
...
export function resolveGeneratedMediaMaxBytes(cfg: KovaConfig | undefined, kind: MediaKind) {
