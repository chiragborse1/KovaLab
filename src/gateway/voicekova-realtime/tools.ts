...
import type { VoiceKovaRealtimeToolDeclaration } from "./types.js";
...
export function buildAsyncToolAck(toolName: string): string {
  return JSON.stringify({
    ...
    tool: toolName,
    message:
      "The Kova tool is running asynchronously. Do not answer with final results yet; wait for the injected tool result.",
  });
}
