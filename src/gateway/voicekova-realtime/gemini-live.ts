...
import type {
  VoiceKovaRealtimeAdapterOptions,
  VoiceKovaRealtimeAdapter,
  VoiceKovaSendToClient,
  VoiceKovaSessionConfigEvent,
  VoiceKovaRealtimeToolDeclaration,
} from "./types.js";
...
export class VoiceKovaGeminiLiveAdapter implements VoiceKovaRealtimeAdapter {
  private upstream: WebSocket | null = null;
  private sendToClient: VoiceKovaSendToClient | null = null;
  private config: VoiceKovaSessionConfigEvent | null = null;
  private tools: VoiceKovaRealtimeToolDeclaration[] = [];
  ...
  private sendSetup(config: VoiceKovaSessionConfigEvent, model: string): void {
