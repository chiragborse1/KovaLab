...
import { attachKovaTranscriptMeta, readSessionMessages } from "./session-utils.js";
...
export type SessionHistoryMessage = Record<string, unknown> & {
  __kova?: SessionHistoryTranscriptMeta;
};
...
export class SessionHistorySseState {
  ...
  appendInlineMessage(update: {
    ...
    const nextMessage = attachKovaTranscriptMeta(update.message, {
