...
export const ConnectErrorDetailCodes = {
  ...
  OPERATOR_CLIENT_ORIGIN_NOT_ALLOWED: "OPERATOR_CLIENT_ORIGIN_NOT_ALLOWED",
  OPERATOR_CLIENT_DEVICE_IDENTITY_REQUIRED: "OPERATOR_CLIENT_DEVICE_IDENTITY_REQUIRED",
