...
export function hasAmbiguousGatewayAuthModeConfig(cfg: KovaConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: KovaConfig): void {
