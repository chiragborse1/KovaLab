...
function listConfiguredAnnounceChannelIds(cfg: KovaConfig): string[] {
...
function assertValidCronAnnounceDelivery(params: { cfg: KovaConfig; delivery?: CronDelivery }) {
...
function assertValidCronCreateDelivery(cfg: KovaConfig, jobCreate: CronJobCreate) {
