...
export const PLUGIN_MANIFEST_FILENAME = "kova.plugin.json";
...
export type PluginManifestActivation = {
  /** Start this plugin during gateway startup. Use sparingly; prefer narrower activation metadata. */
  onStartup?: boolean;
  /**
...
function normalizeManifestActivation(value: unknown): PluginManifestActivation | undefined {
  ...
  const activation = {
    ...(value.onStartup === true ? { onStartup: true } : {}),
...
// package.json "kova" metadata (used for setup/catalog)
