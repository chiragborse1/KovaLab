...
const resolveAuthAgentDir = (agentDir?: string) => agentDir ?? resolveKovaAgentDir();
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: KovaConfig): SecretRef {
