...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "imessage", relativePath: "runtime-api.ts" })]:
    [
      'export { DEFAULT_ACCOUNT_ID, getChatChannelMeta, type ChannelPlugin, type KovaConfig } from "getkova/plugin-sdk/core";',
      ...
      'export { buildComputedAccountStatusSnapshot, collectStatusIssuesFromLastError } from "getkova/plugin-sdk/status-helpers";',
      'export { formatTrimmedAllowFromEntries } from "getkova/plugin-sdk/channel-config-helpers";',
      ...
      'export type IMessageAccountConfig = Omit< NonNullable<NonNullable<RuntimeApiKovaConfig["channels"]>["imessage"]>, "accounts" | "defaultAccount" >;',
    ],
  [bundledPluginFile({
    rootDir: ROOT_DIR,
    pluginId: "googlechat",
    ...
    'export { createActionGate, jsonResult, readNumberParam, readReactionParams, readStringParam } from "getkova/plugin-sdk/channel-actions";',
    'export { buildChannelConfigSchema } from "getkova/plugin-sdk/channel-config-primitives";',
    'export type { ChannelMessageActionAdapter, ChannelMessageActionName, ChannelStatusIssue } from "getkova/plugin-sdk/channel-contract";',
    'export { missingTargetError } from "getkova/plugin-sdk/channel-feedback";',
    'export { createAccountStatusSink, runPassiveAccountLifecycle } from "getkova/plugin-sdk/channel-lifecycle";',
    ...
    'export { evaluateGroupRouteAccessForPolicy, resolveDmGroupAccessWithLists, resolveSenderScopedGroupPolicy } from "getkova/plugin-sdk/channel-policy";',
    'export { PAIRING_APPROVED_MESSAGE } from "getkova/plugin-sdk/channel-status";',
    ...
    'export { GROUP_POLICY_BLOCKED_LABEL, isDangerousNameMatchingEnabled, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "getkova/plugin-sdk/config-runtime";',
    ...
    'export { GoogleChatConfigSchema, type GoogleChatAccountConfig, type GoogleChatConfig } from "getkova/plugin-sdk/googlechat-runtime-shared";',
    ...
    'export { registerWebhookTargetWithPluginRoute, resolveWebhookTargetWithAuthOrReject, withResolvedWebhookRequestPipeline } from "getkova/plugin-sdk/webhook-targets";',
    'export { createWebhookInFlightLimiter, readJsonWebhookBodyOrReject, type WebhookInFlightLimiter } from "getkova/plugin-sdk/webhook-request-guards";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "msteams", relativePath: "runtime-api.ts" })]: [
    ...
    'export { mergeAllowlist, resolveAllowlistMatchSimple, summarizeMapping } from "getkova/plugin-sdk/allow-from";',
    'export type { BaseProbeResult, ChannelDirectoryEntry, ChannelGroupContext, ChannelMessageActionName, ChannelOutboundAdapter } from "getkova/plugin-sdk/channel-contract";',
    ...
    'export { createChannelPairingController } from "getkova/plugin-sdk/channel-pairing";',
    'export { evaluateSenderGroupAccessForPolicy, readStoreAllowFromForDmPolicy, resolveDmGroupAccessWithLists, resolveEffectiveAllowFromLists, resolveSenderScopedGroupPolicy, resolveToolsBySender } from "getkova/plugin-sdk/channel-policy";',
    'export { createChannelReplyPipeline } from "getkova/plugin-sdk/channel-reply-pipeline";',
    'export { PAIRING_APPROVED_MESSAGE, buildProbeChannelStatusSummary, createDefaultChannelRuntimeState } from "getkova/plugin-sdk/channel-status";',
    'export { buildChannelKeyCandidates, normalizeChannelSlug, resolveChannelEntryMatchWithFallback, resolveNestedAllowlistDecision } from "getkova/plugin-sdk/channel-targets";',
    'export type { GroupPolicy, GroupToolPolicyConfig, MSTeamsChannelConfig, MSTeamsConfig, MSTeamsReplyStyle, MSTeamsTeamConfig, MarkdownTableMode, KovaConfig } from "getkova/plugin-sdk/config-runtime";',
    'export { isDangerousNameMatchingEnabled, resolveDefaultGroupPolicy } from "getkova/plugin-sdk/config-runtime";',
    ...
    'export { detectMime, extensionForMime, extractOriginalFilename, getFileExtension, resolveChannelMediaMaxBytes } from "getkova/plugin-sdk/media-runtime";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "matrix", relativePath: "runtime-api.ts" })]: [
    ...
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromDangerouslyAllowPrivateNetwork, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "getkova/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, KovaConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "getkova/plugin-sdk/matrix-runtime-shared";',
    'export { formatZonedTimestamp } from "getkova/plugin-sdk/matrix-runtime-shared";',
  ...
  [bundledPluginFile({
    ...
    'export { createChannelPairingController } from "getkova/plugin-sdk/channel-pairing";',
    'export { readStoreAllowFromForDmPolicy, resolveDmGroupAccessWithCommandGate } from "getkova/plugin-sdk/channel-policy";',
    'export type { BlockStreamingCoalesceConfig, DmConfig, DmPolicy, GroupPolicy, GroupToolPolicyConfig, KovaConfig } from "getkova/plugin-sdk/config-runtime";',
    'export { GROUP_POLICY_BLOCKED_LABEL, resolveAllowlistProviderRuntimeGroupPolicy, resolveDefaultGroupPolicy, warnMissingProviderGroupPolicyFallbackOnce } from "getkova/plugin-sdk/config-runtime";',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "telegram", relativePath: "runtime-api.ts" })]:
    [
      'export type { KovaPluginApi } from "getkova/plugin-sdk/plugin-entry";',
      'export type { ChannelMessageActionAdapter } from "getkova/plugin-sdk/channel-contract";',
      'export type { TelegramApiOverride } from "./src/send.js";',
      'export type { KovaPluginService, KovaPluginServiceContext, PluginLogger } from "getkova/plugin-sdk/plugin-entry";',
      'export type { PluginRuntime } from "getkova/plugin-sdk/runtime-store";',
      'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "getkova/plugin-sdk/acp-runtime";',
      'export { AcpRuntimeError } from "getkova/plugin-sdk/acp-runtime";',
      'export { emptyPluginConfigSchema, formatPairingApproveHint, getChatChannelMeta } from "getkova/plugin-sdk/channel-plugin-common";',
      'export { clearAccountEntryFields } from "getkova/plugin-sdk/channel-core";',
      ...
      'export { PAIRING_APPROVED_MESSAGE, buildTokenChannelStatusSummary, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses } from "getkova/plugin-sdk/channel-status";',
      'export { jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections } from "getkova/plugin-sdk/channel-actions";',
      ...
      'export type { ChannelPlugin } from "getkova/plugin-sdk/channel-core";',
      'export type { KovaConfig } from "getkova/plugin-sdk/config-runtime";',
      'export type TelegramAccountConfig = NonNullable< NonNullable<RuntimeKovaConfig["channels"]>["telegram"] >;',
  ...
  [bundledPluginFile({ rootDir: ROOT_DIR, pluginId: "twitch", relativePath: "runtime-api.ts" })]: [
    'export type { ChannelAccountSnapshot, ChannelCapabilities, ChannelGatewayContext, ChannelLogSink, ChannelMessageActionAdapter, ChannelMessageActionContext, ChannelMeta, ChannelOutboundAdapter, ChannelOutboundContext, ChannelResolveKind, ChannelResolveResult, ChannelStatusAdapter } from "getkova/plugin-sdk/channel-contract";',
    'export type { ChannelPlugin } from "getkova/plugin-sdk/channel-core";',
  ...
  [bundledPluginFile({
    ...
    'export type { KovaPluginApi } from "getkova/plugin-sdk/plugin-entry";',
    'export type { GatewayRequestHandlerOptions } from "getkova/plugin-sdk/gateway-runtime";',
    'export { isRequestBodyLimitError, readRequestBodyWithLimit, requestBodyErrorToText } from "getkova/plugin-sdk/webhook-request-guards";',
    'export { fetchWithSsrFGuard, isBlockedHostnameOrIp } from "getkova/plugin-sdk/ssrf-runtime";',
    'export type { SessionEntry } from "getkova/plugin-sdk/session-store-runtime";',
    'export { TtsAutoSchema, TtsConfigSchema, TtsModeSchema, TtsProviderSchema } from "getkova/plugin-sdk/tts-runtime";',
    'export { sleep } from "getkova/plugin-sdk/runtime-env";',
  ],
...
describe("runtime api guardrails", () => {
  ...
  it("keeps bundled runtime api barrels off their own branded sdk facades", () => {
    for (const file of collectBundledRuntimeApiFiles()) {
      ...
      ).not.toContain(`"getkova/plugin-sdk/${pluginId}"`);
      expect(
        source,
        `${pluginId} runtime api should use generic sdk subpaths or local exports`,
      ).not.toContain(`'getkova/plugin-sdk/${pluginId}'`);
