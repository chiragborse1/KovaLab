...
function expectLoaderCall(overrides: Record<string, unknown>) {
  expect(loadKovaPluginsMock).toHaveBeenCalledWith(expect.objectContaining(overrides));
}
...
describe("resolvePluginTools optional tools", () => {
  ...
  beforeEach(() => {
    loadKovaPluginsMock.mockClear();
    resolveRuntimePluginRegistryMock.mockReset();
    resolveRuntimePluginRegistryMock.mockImplementation((params) => loadKovaPluginsMock(params));
