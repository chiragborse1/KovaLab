...
export type PluginCliCommandGroupEntry = {
  pluginId: string;
  placeholders: readonly KovaPluginCliCommandDescriptor[];
  names: readonly string[];
  register: (program: KovaPluginCliContext["program"]) => Promise<void>;
};
...
export async function loadPluginCliMetadataRegistryWithContext(
  ...
  return {
    ...context,
    registry: await loadKovaPluginCliRegistry(
