...
export function resolveKovaManifestBlock(params: {
  frontmatter: Record<string, unknown>;
  key?: string;
...
export function resolveKovaManifestRequires(
  metadataObj: Record<string, unknown>,
): KovaManifestRequires | undefined {
  const requiresRaw =
...
export function resolveKovaManifestInstall<T>(
  metadataObj: Record<string, unknown>,
...
export function resolveKovaManifestOs(metadataObj: Record<string, unknown>): string[] {
...
export function parseKovaManifestInstallBase(
  input: unknown,
  allowedKinds: readonly string[],
): ParsedKovaManifestInstallBase | undefined {
  ...
  const spec: ParsedKovaManifestInstallBase = {
    raw,
    kind,
  };
...
export function applyKovaManifestInstallCommonFields<
