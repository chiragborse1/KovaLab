...
type ExecToolConfig = NonNullable<NonNullable<KovaConfig["tools"]>["exec"]>;
...
async function loadSystemRunConfig(opts: HandleSystemRunInvokeOptions): Promise<KovaConfig> {
