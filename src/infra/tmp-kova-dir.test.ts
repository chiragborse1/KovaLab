...
import { POSIX_KOVA_TMP_DIR, resolvePreferredKovaTmpDir } from "./tmp-kova-dir.js";

type TmpDirOptions = NonNullable<Parameters<typeof resolvePreferredKovaTmpDir>[0]>;
...
function resolveWithReadOnlyTmpFallback(params: {
  ...
  return resolvePreferredKovaTmpDir({
...
function resolveWithMocks(params: {
  ...
  const resolved = resolvePreferredKovaTmpDir({
    accessSync,
    chmodSync,
...
describe("resolvePreferredKovaTmpDir", () => {
