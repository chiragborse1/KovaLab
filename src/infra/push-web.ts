...
const DEFAULT_VAPID_SUBJECT = "mailto:kova@localhost";
...
function resolveVapidSubjectFromEnv(): string {
  return process.env.KOVA_VAPID_SUBJECT || DEFAULT_VAPID_SUBJECT;
}

export function resolveVapidPublicKeyFromEnv(): string | undefined {
  return process.env.KOVA_VAPID_PUBLIC_KEY || undefined;
}

export function resolveVapidPrivateKeyFromEnv(): string | undefined {
  return process.env.KOVA_VAPID_PRIVATE_KEY || undefined;
}
