...
function resolveCollectionNamesForAgent(cfg: KovaConfig, agentId: string): Set<string> {
  return new Set(
...
function resolveCustomCollectionPathsForAgent(cfg: KovaConfig, agentId: string): string[] {
...
describe("resolveMemoryBackendConfig", () => {
  it("defaults to builtin backend when config missing", () => {
    const cfg = { agents: { defaults: { workspace: "/tmp/memory-test" } } } as KovaConfig;
