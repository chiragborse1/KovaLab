...
function resolveAcpStreamCoalesceIdleMs(cfg: KovaConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: KovaConfig): number {
...
export function resolveAcpProjectionSettings(cfg: KovaConfig): AcpProjectionSettings {
