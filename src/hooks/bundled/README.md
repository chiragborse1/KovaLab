...
homepage: https://docs.neuralstudio.in/automation/hooks#my-hook
...
2. Restart gateway: `pkill -9 -f 'kova.*gateway' && pnpm kova gateway`
...
Full documentation: https://docs.neuralstudio.in/automation/hooks
