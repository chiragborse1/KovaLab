...
export const DISABLE_PLUGIN_REGISTRY_MIGRATION_ENV = "KOVA_DISABLE_PLUGIN_REGISTRY_MIGRATION";
export const FORCE_PLUGIN_REGISTRY_MIGRATION_ENV = "KOVA_FORCE_PLUGIN_REGISTRY_MIGRATION";
...
export type PluginRegistryInstallMigrationParams = LoadInstalledPluginIndexParams &
  InstalledPluginIndexStoreOptions & {
    ...
    readConfig?: () => Promise<KovaConfig> | KovaConfig;
  };
...
function listConfiguredChannelIds(config: KovaConfig): Set<string> {
...
function listConfiguredModelProviderIds(config: KovaConfig): Set<string> {
...
export async function migratePluginRegistryForInstall(
  ...
  const config = stripShippedPluginInstallConfigRecords(rawConfig) as KovaConfig;
