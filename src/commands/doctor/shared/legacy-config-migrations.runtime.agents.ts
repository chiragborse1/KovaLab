...
const LEGACY_AGENT_RUNTIME_POLICY_RULES: LegacyConfigRule[] = [
  {
    ...
    message:
      'agents.defaults.embeddedHarness is legacy; use agents.defaults.agentRuntime instead. Run "kova doctor --fix".',
    match: (value) => getRecord(value) !== null,
  },
  {
    path: ["agents", "list"],
    message:
      'agents.list[].embeddedHarness is legacy; use agents.list[].agentRuntime instead. Run "kova doctor --fix".',
