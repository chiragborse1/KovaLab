...
export function collectMissingDefaultAccountBindingWarnings(cfg: KovaConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: KovaConfig): string[] {
  const warnings: string[] = [];
