...
export function hasExplicitMemorySearchConfig(cfg: KovaConfig, agentId: string): boolean {
  if (
    cfg.agents?.defaults &&
...
export function resolveMemoryPluginStatus(cfg: KovaConfig): MemoryPluginStatus {
