...
type BrowserDoctorSurface = {
  noteChromeMcpBrowserReadiness: (cfg: KovaConfig, deps?: BrowserDoctorDeps) => Promise<void>;
};
...
export async function noteChromeMcpBrowserReadiness(cfg: KovaConfig, deps?: BrowserDoctorDeps) {
  try {
