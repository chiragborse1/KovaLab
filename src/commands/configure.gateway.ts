...
export async function promptGatewayConfig(
  ...
  if (authMode === "trusted-proxy") {
    note(
      [
        "Trusted proxy mode: Kova trusts user identity from a reverse proxy.",
        ...
        "Docs: https://docs.neuralstudio.in/gateway/trusted-proxy-auth",
      ].join("\n"),
      "Trusted Proxy Auth",
    );
