...
export function formatWizardBootScreen(): string {
  return [
    ...
    "│                                                        │",
    "│                     Kova Start                         │",
    "│              first chat first, extras later             │",
    "│                                                        │",
    "├────────────────────────────────────────────────────────┤",
    formatBootScreenRow("release", VERSION),
    formatBootScreenRow("goal", "get a working terminal chat"),
    formatBootScreenRow("ask", "model/auth and workspace"),
    formatBootScreenRow("later", "channels, Gateway, skills, web tools"),
    formatBootScreenRow("start", "open kova chat"),
    "╰────────────────────────────────────────────────────────╯",
    "",
  ].join("\n");
}
