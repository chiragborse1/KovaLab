...
export function formatWizardBootScreen(): string {
  return [
    ...
    "│        shape a private agent from model to launch      │",
    "│                                                        │",
    "├────────────────────────────────────────────────────────┤",
    formatBootScreenRow("release", VERSION),
    formatBootScreenRow("phase 1", "choose launch path"),
    formatBootScreenRow("phase 2", "bind workspace + model"),
    formatBootScreenRow("phase 3", "seal gateway + channels"),
    formatBootScreenRow("phase 4", "open terminal or command deck"),
    "╰────────────────────────────────────────────────────────╯",
    "",
  ].join("\n");
}
