...
import { hasAbortableChatRun, refreshChat } from "./app-chat.ts";
        ...
        ${state.tab === "skills"
          ? renderLazyView(lazySkills, (m) =>
              m.renderSkills({
                ...
                sourceFilter: state.skillsSourceFilter,
                selectedKeys: state.skillsSelectedKeys,
                ...
                onSelectionChange: (next) => (state.skillsSelectedKeys = next),
        ...
        ${state.tab === "chat"
          ? guard(chatRenderDeps, () =>
              renderChat({
                ...
                canAbort: hasAbortableChatRun(state),
