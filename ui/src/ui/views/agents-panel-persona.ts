    ...
    <section class="agent-persona-console">
      <section class="card agent-persona-hero">
        ...
        <div class="agent-persona-hero__actions">
          <span class="agent-pill ${bootstrapPending ? "warn" : ""}"> ${bootstrapLabel} </span>
          <button
            type="button"
            class="btn btn--sm"
      ...
      <section class="agent-persona-grid">
        <article class="card agent-persona-identity">
            ...
            ${IDENTITY_FIELDS.map(
              (field) => html`
                <label class="field agent-persona-field">
                  ...
                  <input
                    .value=${identity.loaded ? readIdentityField(identity.draft, field.label) : ""}
          ...
          <details class="agent-persona-raw">
            ...
            <textarea
              ...
              ?disabled=${params.agentFilesLoading || !identity.loaded}
              @input=${(e: Event) =>
                params.onFileDraftChange(IDENTITY_FILE, (e.target as HTMLTextAreaElement).value)}
            ></textarea>
          </details>
          <div class="agent-persona-actions">
            <button
        ...
        ${renderPersonaEditor({
          ...
          eyebrow: "Soul",
          description: "Tone, principles, behavior boundaries, and long-term operating style.",
          fileName: SOUL_FILE,
          state: soul,
