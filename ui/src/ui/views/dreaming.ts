...
const DIARY_START_RE = /<!--\s*kova:dreaming:diary:start\s*-->/;
const DIARY_END_RE = /<!--\s*kova:dreaming:diary:end\s*-->/;
...
const sleepingKova = html`<img
  class="dreams__mascot-image"
  src="Kova_logo.png"
  alt="Kova dreaming"
/>`;
...
function renderScene(props: DreamingProps, idle: boolean, dreamText: string) {
  return html`
    <section class="dreams ${idle ? "dreams--idle" : ""}">
      ...
      <div class="dreams__mascot">${sleepingKova}</div>
