...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    files: "Agent workspace files and editable context.",
    terminal: "Execution hosts, approvals, and terminal readiness.",
    tasks: "Background work, stale runs, and task health signals.",
    conductor: "Agent, job, session, and skill coordination.",
    operations: "Gateway, channels, jobs, nodes, and recent logs.",
    mcp: "Model Context Protocol servers and tool bridges.",
    profiles: "Auth profiles, provider credentials, and model identity.",
