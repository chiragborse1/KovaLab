...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    files: "Workspace files, generated artifacts, and attachments.",
    terminal: "Command execution, node targets, and approvals.",
    tasks: "Background work, run state, and failure evidence.",
    conductor: "Agents, delegation, routing, and orchestration.",
    operations: "Gateway operations, diagnostics, channels, and logs.",
    memory: "Memory, dreaming, reflection, and session knowledge.",
    mcp: "MCP servers, bridge configuration, and exposed tools.",
    profiles: "Model, auth, tool, channel, and operator profiles.",
    config: "kova.json dosyasını düzenleyin.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Mobilde misiniz? Masaüstünüzde kova dashboard --no-open komutundan tam URL'yi (#token=... dahil) kopyalayın.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — kova models auth ile yeniden kimlik doğrulayın",
