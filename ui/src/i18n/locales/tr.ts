...
export const tr: TranslationMap = {
  ...
  subtitles: {
    ...
    files: "Agent workspace instructions and editable core files.",
    overview: "Durum, giriş noktaları, sağlık.",
    operations: "Runtime health, scheduler state, nodes, and recent logs.",
    ...
    profiles: "Agent, model, and session profiles.",
