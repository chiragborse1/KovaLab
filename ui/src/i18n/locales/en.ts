...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    cron: "Scheduled automation and recurring runs.",
    ...
    config: "Edit the Kova config file (kova.json).",
    communications: "Chat apps, message routing, notifications, and voice settings.",
