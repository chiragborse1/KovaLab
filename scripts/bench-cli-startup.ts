...
function printUsage(): void {
  console.log(`Kova CLI benchmark
...
Options:
  ...
  --entry <path>               Primary entry file (default: kova.mjs)
...
async function main(): Promise<void> {
  ...
  const tmpDir = mkdtempSync(path.join(os.tmpdir(), "kova-cli-bench-"));
