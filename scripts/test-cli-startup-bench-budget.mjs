...
const opts = parseFlagArgs(
  process.argv.slice(2),
  {
    ...
    warmup: 0,
    timeoutMs: 30_000,
    maxDurationRegressionPct: readEnvNumber("KOVA_STARTUP_BENCH_MAX_DURATION_REGRESSION_PCT") ?? 20,
    maxRssRegressionPct: readEnvNumber("KOVA_STARTUP_BENCH_MAX_RSS_REGRESSION_PCT") ?? 20,
  },
  [
