...
const env = {
  ...process.env,
  KOVA_LIVE_TEST: process.env.KOVA_LIVE_TEST || "1",
  KOVA_LIVE_TEST_QUIET: quietOverride ?? process.env.KOVA_LIVE_TEST_QUIET ?? "1",
};
...
const heartbeatMs = parsePositiveInt(process.env.KOVA_LIVE_WRAPPER_HEARTBEAT_MS, 20_000);
