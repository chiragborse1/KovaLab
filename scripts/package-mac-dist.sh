...
# Output:
# - dist/Kova.app
# - dist/Kova-<version>.zip
# - dist/Kova-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.kova.mac}"
...
ZIP="$ROOT_DIR/dist/Kova-$VERSION.zip"
DMG="$ROOT_DIR/dist/Kova-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Kova-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Kova-$VERSION.dSYM.zip"
