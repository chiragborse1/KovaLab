...
- KOVA_IOS_VERSION = exact canonical iOS version
- KOVA_MARKETING_VERSION = short iOS/App Store version
- KOVA_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
KOVA_IOS_VERSION = ${IOS_VERSION}
KOVA_MARKETING_VERSION = ${MARKETING_VERSION}
KOVA_BUILD_VERSION = ${BUILD_NUMBER}
EOF
