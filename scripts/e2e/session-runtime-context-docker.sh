...
IMAGE_NAME="$(docker_e2e_resolve_image "kova-session-runtime-context-e2e" KOVA_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="kova-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t kova-session-runtime-context-log.XXXXXX)"
