...
IMAGE_NAME="$(docker_e2e_resolve_image "kova-crestodian-planner-e2e" KOVA_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="kova-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t kova-crestodian-planner-log.XXXXXX)"
