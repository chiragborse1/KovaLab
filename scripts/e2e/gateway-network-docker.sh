...
IMAGE_NAME="$(docker_e2e_resolve_image "kova-gateway-network-e2e" KOVA_GATEWAY_NETWORK_E2E_IMAGE)"
SKIP_BUILD="${KOVA_GATEWAY_NETWORK_E2E_SKIP_BUILD:-0}"

PORT="18789"
TOKEN="e2e-$(date +%s)-$$"
NET_NAME="kova-net-e2e-$$"
GW_NAME="kova-gateway-e2e-$$"
DOCKER_COMMAND_TIMEOUT="${KOVA_GATEWAY_NETWORK_DOCKER_COMMAND_TIMEOUT:-600s}"
CLIENT_TIMEOUT="${KOVA_GATEWAY_NETWORK_CLIENT_TIMEOUT:-90s}"
