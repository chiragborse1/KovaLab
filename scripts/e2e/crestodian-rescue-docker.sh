...
IMAGE_NAME="$(docker_e2e_resolve_image "kova-crestodian-rescue-e2e" KOVA_CRESTODIAN_RESCUE_E2E_IMAGE)"
CONTAINER_NAME="kova-crestodian-rescue-e2e-$$"
RUN_LOG="$(mktemp -t kova-crestodian-rescue-log.XXXXXX)"
