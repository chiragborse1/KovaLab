...
IMAGE_NAME="$(docker_e2e_resolve_image "kova-pi-bundle-mcp-tools-e2e" KOVA_IMAGE)"
CONTAINER_NAME="kova-pi-bundle-mcp-tools-e2e-$$"
RUN_LOG="$(mktemp -t kova-pi-bundle-mcp-tools-log.XXXXXX)"
