...
const (
	envDocsPiExecutable     = "KOVA_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "KOVA_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "KOVA_DOCS_I18N_PI_PACKAGE_VERSION"
	envDocsPiOmitProvider   = "KOVA_DOCS_I18N_PI_OMIT_PROVIDER"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "kova", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
